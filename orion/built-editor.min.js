...
(function(n){function s(a,d){var b,m,q,z,e,t,g,f,u,h=d&&d.split("/"),p=l.map,v=p&&p["*"]||{};if(a&&"."===a.charAt(0))if(d){h=h.slice(0,h.length-1);a=h.concat(a.split("/"));for(f=0;f<a.length;f+=1)if(b=a[f],"."===b)a.splice(f,1),f-=1;else if(".."===b)if(1===f&&(".."===a[2]||".."===a[0]))break;else 0<f&&(a.splice(f-1,2),f-=2);a=a.join("/")}else 0===a.indexOf("./")&&(a=a.substring(2));if((h||v)&&p){b=a.split("/");for(f=b.length;0<f;f-=1){m=b.slice(0,f).join("/");if(h)for(u=h.length;0<u;u-=1)if(q=p[h.slice(0,
u).join("/")])if(q=q[m]){z=q;e=f;break}if(z)break;!t&&(v&&v[m])&&(t=v[m],g=f)}!z&&t&&(z=t,e=g);z&&(b.splice(0,e,z),a=b.join("/"))}return a}function r(a,d){return function(){return b.apply(n,A.call(arguments,0).concat([a,d]))}}function k(a){return function(d){return s(d,a)}}function f(a){return function(d){m[a]=d}}function h(a){if(v.call(t,a)){var d=t[a];delete t[a];u[a]=!0;e.apply(n,d)}if(!v.call(m,a)&&!v.call(u,a))throw Error("No "+a);return m[a]}function g(a){var d,b=a?a.indexOf("!"):-1;-1<b&&(d=
a.substring(0,b),a=a.substring(b+1,a.length));return[d,a]}function p(a){return function(){return l&&l.config&&l.config[a]||{}}}var e,b,a,d,m={},t={},l={},u={},v=Object.prototype.hasOwnProperty,A=[].slice;a=function(a,d){var b,m=g(a),q=m[0];a=m[1];q&&(q=s(q,d),b=h(q));q?a=b&&b.normalize?b.normalize(a,k(d)):s(a,d):(a=s(a,d),m=g(a),q=m[0],a=m[1],q&&(b=h(q)));return{f:q?q+"!"+a:a,n:a,pr:q,p:b}};d={require:function(a){return r(a)},exports:function(a){var d=m[a];return"undefined"!==typeof d?d:m[a]={}},
module:function(a){return{id:a,uri:"",exports:m[a],config:p(a)}}};e=function(b,l,e,g){var q,z,C,p,B=[],A;g=g||b;if("function"===typeof e){l=!l.length&&e.length?["require","exports","module"]:l;for(p=0;p<l.length;p+=1)if(C=a(l[p],g),z=C.f,"require"===z)B[p]=d.require(b);else if("exports"===z)B[p]=d.exports(b),A=!0;else if("module"===z)q=B[p]=d.module(b);else if(v.call(m,z)||v.call(t,z)||v.call(u,z))B[p]=h(z);else if(C.p)C.p.load(C.n,r(g,!0),f(z),{}),B[p]=m[z];else throw Error(b+" missing "+z);l=e.apply(m[b],
B);if(b)if(q&&q.exports!==n&&q.exports!==m[b])m[b]=q.exports;else if(l!==n||!A)m[b]=l}else b&&(m[b]=e)};requirejs=require=b=function(m,t,g,f,q){if("string"===typeof m)return d[m]?d[m](t):h(a(m,t).f);m.splice||(l=m,t.splice?(m=t,t=g,g=null):m=n);t=t||function(){};"function"===typeof g&&(g=f,f=q);f?e(n,m,t,g):setTimeout(function(){e(n,m,t,g)},4);return b};b.config=function(a){l=a;return b};define=function(a,d,b){d.splice||(b=d,d=[]);!v.call(m,a)&&!v.call(t,a)&&(t[a]=[a,d,b])};define.amd={jQuery:!0}})();
define("almond",function(){});define("orion/editor/config",[],function(){return{languages:{}}});
define("orion/editor/shim",[],function(){Object.create||(Object.create=function(n,s){function r(){}r.prototype=n;var k=new r;if(s)for(var f in s)s.hasOwnProperty(f)&&(s[f].hasOwnProperty("value")?k[f]=s[f].value:k[f]=function(){if(0<arguments.length)return s[f].get();s[f].set(arguments)});return k});Object.keys||(Object.keys=function(n){var s=[],r;for(r in n)n.hasOwnProperty(r)&&s.push(r);return s});Function.prototype.bind||(Function.prototype.bind=function(n){var s=this,r=Array.prototype.slice.call(arguments,
1);return r.length?function(){return arguments.length?s.apply(n,r.concat(Array.prototype.slice.call(arguments))):s.apply(n,r)}:function(){return arguments.length?s.apply(n,arguments):s.call(n)}});Array.isArray||(Array.isArray=function(n){return"[object Array]"===Object.prototype.toString.call(n)});Array.prototype.indexOf||(Array.prototype.indexOf=function(n){for(var s=0;s<this.length;s++)if(this[s]===n)return s;return-1});Array.prototype.forEach||(Array.prototype.forEach=function(n){for(var s=0;s<
this.length;s++)n(this[s],s)});Array.prototype.map||(Array.prototype.map=function(n){for(var s=Array(this.length),r=0;r<this.length;r++)s[r]=n(this[r]);return s});Array.prototype.reduce||(Array.prototype.reduce=function(n,s){var r,k=!1;1<arguments.length&&(r=s,k=!0);for(var f=0;this.length>f;++f)k?r=n(r,this[f],f,this):(r=this[f],k=!0);return r});String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});String.prototype.trimLeft||(String.prototype.trimLeft=function(){return this.replace(/^\s+/g,
"")});String.prototype.trimRight||(String.prototype.trimRight=function(){return this.replace(/\s+$/g,"")});return{}});
(function(){function n(f,h,g,p,e,b){h[f]&&(g.push(f),(!0===h[f]||1===h[f])&&p.push(e+f+"/"+b))}function s(f,h,g,p,e){h=p+h+"/"+e;require._fileExists(f.toUrl(h+".js"))&&g.push(h)}function r(f,h,g){for(var p in h)h.hasOwnProperty(p)&&(!f.hasOwnProperty(p)||g)?f[p]=h[p]:"object"===typeof h[p]&&r(f[p],h[p],g)}var k=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(f){var h=f.config?f.config():{},h=h||{};return{version:"2.0.1+",load:function(g,f,e,b){b=b||{};b.locale&&(h.locale=
b.locale);var a=k.exec(g),d=a[1],m=a[4],t=a[5],l=m.split("-"),u=[],v={},A,w="";a[5]?(d=a[1],g=d+t):(t=a[4],m=h.locale,m||(m=h.locale="undefined"===typeof navigator?"root":(navigator.language||navigator.userLanguage||"root").toLowerCase()),l=m.split("-"));if(b.isBuild){u.push(g);s(f,"root",u,d,t);for(A=0;A<l.length;A++)b=l[A],w+=(w?"-":"")+b,s(f,w,u,d,t);f(u,function(){e()})}else f([g],function(a){var b=[],m;n("root",a,b,u,d,t);for(A=0;A<l.length;A++)m=l[A],w+=(w?"-":"")+m,n(w,a,b,u,d,t);f(u,function(){var q,
z,m;for(q=b.length-1;-1<q&&b[q];q--){m=b[q];z=a[m];if(!0===z||1===z)z=f(d+m+"/"+t);r(v,z)}e(v)})})}}})})();define("orion/editor/i18n",{load:function(n,s,r,k){s.specified&&s.specified("orion/bootstrap")?s(["orion/i18n!"+n],function(f){r(f)}):s(["orion/editor/config"],function(f){r(f&&f.languages||{})})}});
...
nothingReplaced:"Nothing replaced",notFound:"Not found"});define("orion/editor/nls/messages",["orion/editor/i18n!orion/editor/nls/messages","orion/editor/nls/root/messages"],function(n,s){var r={root:s},k;for(k in n)n.hasOwnProperty(k)&&"undefined"===typeof r[k]&&(r[k]=n[k]);return r});
define("orion/editor/eventTarget",[],function(){function n(){}n.addMixin=function(s){var r=n.prototype,k;for(k in r)r.hasOwnProperty(k)&&(s[k]=r[k])};n.prototype={addEventListener:function(n,r,k){this._eventTypes||(this._eventTypes={});var f=this._eventTypes[n];f||(f=this._eventTypes[n]={level:0,listeners:[]});f.listeners.push({listener:r,useCapture:k})},dispatchEvent:function(n){var r=n.type;this._dispatchEvent("pre"+r,n);this._dispatchEvent(r,n);this._dispatchEvent("post"+r,n)},_dispatchEvent:function(n,
...
define("orion/util",[],function(){var n=navigator.userAgent,s=-1!==n.indexOf("MSIE")||-1!==n.indexOf("Trident")?document.documentMode:void 0,r=parseFloat(n.split("Firefox/")[1]||n.split("Minefield/")[1])||void 0,k=-1!==n.indexOf("Opera")?parseFloat(n.split("Version/")[1]):void 0,f=parseFloat(n.split("Chrome/")[1])||void 0,h=-1!==n.indexOf("Safari")&&!f,g=parseFloat(n.split("WebKit/")[1])||void 0,p=-1!==n.indexOf("Android"),e=-1!==n.indexOf("iPad"),n=-1!==n.indexOf("iPhone"),b=e||n,a=-1!==navigator.platform.indexOf("Mac"),
d=-1!==navigator.platform.indexOf("Win"),m=-1!==navigator.platform.indexOf("Linux"),t="ontouchstart"in document.createElement("input");return{formatMessage:function(a){var d=arguments;return a.replace(/\$\{([^\}]+)\}/g,function(a,b){return d[(b<<0)+1]})},createElement:function(a,d){return a.createElementNS?a.createElementNS("http://www.w3.org/1999/xhtml",d):a.createElement(d)},isIE:s,isFirefox:r,isOpera:k,isChrome:f,isSafari:h,isWebkit:g,isAndroid:p,isIPad:e,isIPhone:n,isIOS:b,isMac:a,isWindows:d,
isLinux:m,isTouch:t,platformDelimiter:d?"\r\n":"\n"}});
define("orion/editor/textModel",["orion/editor/eventTarget","orion/regex","orion/util"],function(n,s,r){function k(f,h){this._lastLineIndex=-1;this._text=[""];this._lineOffsets=[0];this.setText(f);this.setLineDelimiter(h)}k.prototype={destroy:function(){},find:function(f){1<this._text.length&&(this._text=[this._text.join("")]);var h=f.string,g=f.regex,p=h,e="",b=f.caseInsensitive;if(p)if(g){if(h=s.parse(p))p=h.pattern,e=h.flags}else p=h.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$\x26"),b&&(p=p.replace(/[iI\u0130\u0131]/g,
"[Ii\u0130\u0131]"));var a=null,d;if(p){var h=f.reverse,m=f.wrap,g=f.wholeWord,t=f.start||0;f=f.end;var l=null!==f&&void 0!==f;-1===e.indexOf("g")&&(e+="g");-1===e.indexOf("m")&&(e+="m");b&&-1===e.indexOf("i")&&(e+="i");g&&(p="\\b"+p+"\\b");var u=this._text[0],v,A,k=0;l&&(b=t<f?t:f,u=u.substring(b,t<f?f:t),k=b);var n=RegExp(p,e);h?d=function(){var a=null;for(n.lastIndex=0;;){A=n.lastIndex;v=n.exec(u);if(A===n.lastIndex)return null;if(v){if(!(v.index+k<t)){if(!m||a)break;t=u.length+k}a={start:v.index+
k,end:n.lastIndex+k}}else break}a&&(t=a.start);return a}:(l||(n.lastIndex=t),d=function(){for(;;){A=n.lastIndex;v=n.exec(u);if(A===n.lastIndex)break;if(v)return{start:v.index+k,end:n.lastIndex+k};if(!(0!==A&&m))break}return null});a=d()}return{next:function(){var b=a;b&&(a=d());return b},hasNext:function(){return null!==a}}},getCharCount:function(){for(var f=0,h=0;h<this._text.length;h++)f+=this._text[h].length;return f},getLine:function(f,h){var g=this.getLineCount();if(!(0<=f&&f<g))return null;
...
this.getCharCount());if(!(h===g&&""===f)){for(var p=this.getLineAtOffset(h),e=this.getLineAtOffset(g),b=h,a=g-h,d=e-p,m=f.length,t=0,l=this.getLineCount(),u=0,v=0,k=0,w=[];;){-1!==u&&u<=k&&(u=f.indexOf("\r",k));-1!==v&&v<=k&&(v=f.indexOf("\n",k));if(-1===v&&-1===u)break;k=-1!==u&&-1!==v?u+1===v?v+1:(u<v?u:v)+1:-1!==u?u+1:v+1;w.push(h+k);t++}this.onChanging({type:"Changing",text:f,start:b,removedCharCount:a,addedCharCount:m,removedLineCount:d,addedLineCount:t});0===w.length&&(k=this.getLineStart(p),
...
keyBinding:new f(37,!0,!0),predefined:!0}),h.push({actionID:"selectWordNext",keyBinding:new f(39,!0,!0),predefined:!0}),h.push({actionID:"selectTextStart",keyBinding:new f(36,!0,!0),predefined:!0}),h.push({actionID:"selectTextEnd",keyBinding:new f(35,!0,!0),predefined:!0}));h.push({actionID:"undo",keyBinding:new n.KeyBinding("z",!0),predefined:!0});s.isMac?h.push({actionID:"redo",keyBinding:new n.KeyBinding("z",!0,!0),predefined:!0}):h.push({actionID:"redo",keyBinding:new n.KeyBinding("y",!0),predefined:!0});
...
define("orion/editor/textTheme",["require","orion/editor/eventTarget","orion/util"],function(n,s,r){function k(f){f=f||{};this._document=f.document||document}var f={};k.getTheme=function(h){h=h||"default";var g=f[h];g||(g=f[h]=new k);return g};k.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(f,g){var p=this,e=p._themeClass;p._themeClass=f;this._load(f,g,function(){p.onThemeChanged({type:"ThemeChanged",oldValue:e,newValue:p.getThemeClass()})})},onThemeChanged:function(f){return this.dispatchEvent(f)},
...
".css"!==g.substring(g.length-4)&&(g+=".css"),/^\//.test(g)||/[a-zA-Z0-9]+:\/\//i.test(g)||!n.toUrl)this._createStyle(f,g,p,!0);else{var e=this;n(["text!"+g],function(b){e._createStyle(f,b,p,!1)})}else p()}};s.EventTarget.addMixin(k.prototype);return{TextTheme:k}});
define("orion/editor/util",[],function(){return{contains:function(n,s){if(!s)return!1;if(!n.compareDocumentPosition){for(var r=s;r;){if(n===r)return!0;r=r.parentNode}return!1}return n===s||0!==(n.compareDocumentPosition(s)&16)},addEventListener:function(n,s,r,k){"function"===typeof n.addEventListener?n.addEventListener(s,r,!0===k):n.attachEvent("on"+s,r)},removeEventListener:function(n,s,r,k){"function"===typeof n.removeEventListener?n.removeEventListener(s,r,!0===k):n.detachEvent("on"+s,r)},Animation:function(){function n(n){this.options=
...
define("orion/editor/textView","i18n!orion/editor/nls/messages orion/editor/textModel orion/editor/keyModes orion/editor/eventTarget orion/editor/textTheme orion/editor/util orion/util".split(" "),function(n,s,r,k,f,h,g){function p(q,a,d){if(d){a.className="";d=a.attributes;for(var b=d.length;0<b--;)(!g.isIE||9<=g.isIE||9>g.isIE&&d[b].specified)&&a.removeAttribute(d[b].name)}if(q){q.styleClass&&(a.className=q.styleClass);if(d=q.style)for(var m in d)d.hasOwnProperty(m)&&(a.style[m]=d[m]);if(q=q.attributes)for(var l in q)q.hasOwnProperty(l)&&
...
A.prototype={create:function(q,a){if(!this._lineDiv){var d=this._lineDiv=this._createLine(q,a,this.lineIndex);d._line=this;return d}},_createLine:function(q,d,b){var m=this.view,l=m._model,e=l.getLine(b),t=l.getLineStart(b),f={type:"LineStyle",textView:m,lineIndex:b,lineText:e,lineStart:t};m.onLineStyle(f);var u=q.ownerDocument,l=d||g.createElement(u,"div");if(!d||!a(d.viewStyle,f.style))p(f.style,l,d),d&&(d._trim=null),l.viewStyle=f.style,l.setAttribute("role","presentation");l.lineIndex=b;if(d&&
l.viewLineText===e&&a(f.ranges,l.viewRanges))return l;l.viewRanges=f.ranges;l.viewLineText=e;b=[];this._createRanges(f.ranges,e,0,e.length,t,{tabOffset:0,ranges:b});f=" ";!m._fullSelection&&9>g.isIE&&(f="\ufeff");m={text:f,style:m._metrics.largestFontStyle,ignoreChars:1};0===b.length||!b[b.length-1].style||"div"!==b[b.length-1].style.tagName?b.push(m):b.splice(b.length-1,0,m);var h,v,k,A=f=0;if(g.isFirefox&&2E3<e.length){d&&(l.innerHTML="",d.lineWidth=void 0);d=u.createDocumentFragment();for(e=0;e<
b.length;e++)m=b[e],t=m.text,h=m.style,h=this._createSpan(l,t,h,m.ignoreChars),d.appendChild(h);l.appendChild(d)}else{var w,n;if(d){if(v=d.modelChangedEvent)0===v.removedLineCount&&0===v.addedLineCount?(n=v.start-t,w=v.addedCharCount-v.removedCharCount):n=-1,d.modelChangedEvent=void 0;v=d.firstChild}for(e=0;e<b.length;e++){m=b[e];t=m.text;f+=t.length;h=m.style;if(v)if(k=v.firstChild.data,u=v.viewStyle,k===t&&a(h,u)){A+=k.length;v._rectsCache=void 0;h=v=v.nextSibling;continue}else for(;v;){if(-1!==
n){u=f;u>=n&&(u-=w);k=(k=v.firstChild.data)?k.length:0;if(A+k>u)break;A+=k}u=v.nextSibling;l.removeChild(v);v=u}h=this._createSpan(l,t,h,m.ignoreChars);v?l.insertBefore(h,v):l.appendChild(h);d&&(d.lineWidth=void 0)}if(d)for(w=h?h.nextSibling:null;w;)u=w.nextSibling,d.removeChild(w),w=u}l.parentNode||q.appendChild(l);return l},_createRanges:function(q,d,b,m,l,e){if(!(b>m)){if(q)for(var t=0;t<q.length;t++){var g=q[t];if(!(g.end<l+b)){var f=Math.max(l+b,g.start)-l;if(f>m)break;var u=Math.min(l+m,g.end)-
l;if(f<=u){f=Math.max(b,f);u=Math.min(m,u);b<f&&this._createRange(d,b,f,null,e);if(!g.style||!g.style.unmergeable)for(;t+1<q.length&&q[t+1].start-l===u&&a(g.style,q[t+1].style);)g=q[t+1],u=Math.min(l+m,g.end)-l,t++;this._createRange(d,f,u,g.style,e);b=u}}}b<m&&this._createRange(d,b,m,null,e)}},_createRange:function(q,a,d,b,m){if(!(a>d)){var l=this.view._customTabSize;if(l&&8!==l)for(var e=q.indexOf("\t",a);-1!==e&&e<d;){a<e&&(a={text:q.substring(a,e),style:b},m.ranges.push(a),m.tabOffset+=a.text.length);
a=l-m.tabOffset%l;if(0<a){for(var t="\u00a0",g=1;g<a;g++)t+=" ";a={text:t,style:b,ignoreChars:a-1};m.ranges.push(a);m.tabOffset+=a.text.length}a=e+1;if(a===d)return;e=q.indexOf("\t",a)}a<=d&&(a={text:q.substring(a,d),style:b},m.ranges.push(a),m.tabOffset+=a.text.length)}},_createSpan:function(q,a,d,b){var m=this.view,l="span";d&&d.tagName&&(l=d.tagName.toLowerCase());var e="a"===l;e&&(this.hasLink=!0);e&&!m._linksVisible&&(l="span");e=q.ownerDocument;q=g.createElement(q.ownerDocument,l);q.appendChild(e.createTextNode(d&&
d.text?d.text:a));d&&d.html?(q.innerHTML=d.html,q.ignore=!0):d&&d.node&&(q.appendChild(d.node),q.ignore=!0);p(d,q);if("a"===l){var t=m._getWindow();y(q,"click",function(q){return m._handleLinkClick(q?q:t.event)},!1)}q.viewStyle=d;b&&(q.ignoreChars=b);return q},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(q,a){var d=this._ensureCreated(),b=this.view;if(void 0===q)return this._getLineBoundingClientRect(d,
!0);var m=b._model,l=d.ownerDocument,e=this.lineIndex,t=null;if(q<m.getLineEnd(e)){var f=m.getLineStart(e);this.forEach(function(a){var m=a.firstChild,z=this._nodeLength(a);if(f+z>q){var e=q-f;if(1===m.length)t=new v(a.getBoundingClientRect());else if(b._isRangeRects)z=l.createRange(),z.setStart(m,e),z.setEnd(m,e+1),t=new v(z.getBoundingClientRect());else if(g.isIE)z=l.body.createTextRange(),z.moveToElementText(a),z.collapse(),(m=0===e&&8===g.isIE)&&(e=1),z.moveEnd("character",e+1),z.moveStart("character",
e),t=new v(z.getBoundingClientRect()),m&&(t.left=a.getClientRects()[0].left);else{var u=m.data;a.removeChild(m);a.appendChild(l.createTextNode(u.substring(0,e)));var h=g.createElement(l,"span");h.appendChild(l.createTextNode(u.substring(e,e+1)));a.appendChild(h);a.appendChild(l.createTextNode(u.substring(e+1)));t=new v(h.getBoundingClientRect());a.innerHTML="";a.appendChild(m);this._createdDiv||(a=b._getSelection(),(f<=a.start&&a.start<f+z||f<=a.end&&a.end<f+z)&&b._updateDOMSelection())}g.isIE&&(e=
d.ownerDocument.defaultView||d.ownerDocument.parentWindow,a=e.screen.logicalXDPI/e.screen.deviceXDPI,e=e.screen.logicalYDPI/e.screen.deviceYDPI,t.left*=a,t.right*=a,t.top*=e,t.bottom*=e);return!1}f+=z;return!0})}m=this.getBoundingClientRect();t||(b._wrapMode?(e=this.getClientRects(),t=e[e.length-1],t.left=t.right,t.left+=m.left,t.top+=m.top,t.right+=m.left,t.bottom+=m.top):(t=new v(m),t.left=t.right));if(a||void 0===a)t.left-=m.left,t.top-=m.top,t.right-=m.left,t.bottom-=m.top;return t},forEach:function(q){for(var a=
...
this.forEach(function(q){q=this._getClientRects(q,d);for(var b=0;b<q.length;b++){var m=q[b],l,e;if(m.top!==m.bottom){var t=m.top+(m.bottom-m.top)/2;for(l=0;l<a.length&&!(e=a[l],e.top<=t&&t<e.bottom);l++);l===a.length?a.push(m):(m.left<e.left&&(e.left=m.left),m.top<e.top&&(e.top=m.top),m.right>e.right&&(e.right=m.right),m.bottom>e.bottom&&(e.bottom=m.bottom))}}return!0});return void 0!==q?a[q]:a},_getLineBoundingClientRect:function(q,a){var d=new v(q.getBoundingClientRect());if(!this.view._wrapMode){d.right=
d.left;for(var b=q.lastChild;b&&b.ignoreChars===b.firstChild.length;)b=b.previousSibling;b&&(b=b.getBoundingClientRect(),d.right=b.right+t(q).right)}a&&(b=t(q),d.left+=b.left,d.right-=b.right);return d},getLineCount:function(){return!this.view._wrapMode?1:this.getClientRects().length},getLineIndex:function(q){if(!this.view._wrapMode)return 0;var a=this.getClientRects();q=this.getBoundingClientRect(q);q=q.top+(q.bottom-q.top)/2;for(var d=0;d<a.length;d++)if(a[d].top<=q&&q<a[d].bottom)return d;return a.length-
...
t,this.forEach(function(q){n=q;if(k=b(n))return!1;w+=this._nodeLength(n);return!0});n&&k&&(this._lastHitChild=n,this._lastHitOffset=w,w=d(n,w,k));return Math.min(f,Math.max(t,w))},getNextOffset:function(q,a){if("line"===a.unit){var d=this.view._model,b=d.getLineAtOffset(q);if(0<a.count)return a.count--,d.getLineEnd(b);a.count++;return d.getLineStart(b)}return"wordend"===a.unit||"wordWS"===a.unit||"wordendWS"===a.unit?this._getNextOffset_W3C(q,a):g.isIE?this._getNextOffset_IE(q,a):this._getNextOffset_W3C(q,
a)},_getNextOffset_W3C:function(q,a){function d(q){return 33<=q&&47>=q||58<=q&&64>=q||91<=q&&94>=q||96===q||123<=q&&126>=q}function b(q){return 32===q||9===q}var m=this.view._model,l=m.getLineAtOffset(q),e=m.getLine(l),t=m.getLineStart(l),m=m.getLineEnd(l),l=e.length,g=q-t,f,u=0>a.count?-1:1;if("word"===a.unit||"wordend"===a.unit||"wordWS"===a.unit||"wordendWS"===a.unit)for(var h,p,v;0!==a.count;){if(0<a.count){if(g===l)return m;f=e.charCodeAt(g);h=d(f);p=!h&&!b(f);for(g++;g<l;){f=e.charCodeAt(g);
if("wordWS"!==a.unit&&"wordendWS"!==a.unit){v=d(f);if("wordend"===a.unit){if(!v&&h)break}else if(v&&!h)break;f=!v&&!b(f)}else f=!b(f);if("wordend"===a.unit||"wordendWS"===a.unit){if(!f&&p)break}else if(f&&!p)break;p=f;h=v;g++}}else{if(0===g)return t;g--;f=e.charCodeAt(g);h=d(f);for(p=!h&&!b(f);0<g;){f=e.charCodeAt(g-1);if("wordWS"!==a.unit&&"wordendWS"!==a.unit){v=d(f);if("wordend"===a.unit){if(v&&!h)break}else if(!v&&h)break;f=!v&&!b(f)}else f=!b(f);if("wordend"===a.unit||"wordendWS"===a.unit){if(f&&
!p)break}else if(!f&&p)break;p=f;h=v;g--}}a.count-=u}else for(;0!==a.count&&0<=g+u&&g+u<=l;)g+=u,f=e.charCodeAt(g),56320<=f&&57343>=f&&0<g&&(f=e.charCodeAt(g-1),55296<=f&&56319>=f&&(g+=u)),a.count-=u;return t+g},_getNextOffset_IE:function(q,a){var d=this._ensureCreated(),b=this.view._model,m=this.lineIndex,l=0,e;e=b.getLineStart(m);var t=b.getLine(m),g=b.getLineStart(m),f=d.ownerDocument,u=0>a.count?-1:1;if(q===b.getLineEnd(m)){for(d=d.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;
...
b.destroy();return d},getLineAtOffset:function(q){this.getModel().getLineAtOffset(q)},getLineStart:function(q){this.getModel().getLineStart(q)},getRulers:function(){return this._rulers.slice(0)},getSelection:function(){var q=this._getSelection();return{start:q.start,end:q.end}},getText:function(q,a){return this._model.getText(q,a)},getTopIndex:function(q){return!this._clientDiv?0:this._getTopIndex(q)},getTopPixel:function(){return!this._clientDiv?0:this._getScroll().y},invokeAction:function(q,a,d){if(this._clientDiv){if(q=
this._actions[q]){if(!a&&q.handler&&q.handler(d))return!0;if(q.defaultHandler)return"boolean"===typeof q.defaultHandler(d)}return!1}},isDestroyed:function(){return!this._clientDiv},onContextMenu:function(q){return this.dispatchEvent(q)},onDragStart:function(q){return this.dispatchEvent(q)},onDrag:function(q){return this.dispatchEvent(q)},onDragEnd:function(q){return this.dispatchEvent(q)},onDragEnter:function(q){return this.dispatchEvent(q)},onDragOver:function(q){return this.dispatchEvent(q)},onDragLeave:function(q){return this.dispatchEvent(q)},
onDrop:function(q){return this.dispatchEvent(q)},onDestroy:function(q){return this.dispatchEvent(q)},onLineStyle:function(q){return this.dispatchEvent(q)},onKeyDown:function(q){return this.dispatchEvent(q)},onKeyPress:function(q){return this.dispatchEvent(q)},onKeyUp:function(q){return this.dispatchEvent(q)},onModelChanged:function(q){return this.dispatchEvent(q)},onModelChanging:function(q){return this.dispatchEvent(q)},onModify:function(q){return this.dispatchEvent(q)},onMouseDown:function(q){return this.dispatchEvent(q)},
onMouseUp:function(q){return this.dispatchEvent(q)},onMouseMove:function(q){return this.dispatchEvent(q)},onMouseOver:function(q){return this.dispatchEvent(q)},onMouseOut:function(q){return this.dispatchEvent(q)},onSelection:function(q){return this.dispatchEvent(q)},onScroll:function(q){return this.dispatchEvent(q)},onVerify:function(q){return this.dispatchEvent(q)},onFocus:function(q){return this.dispatchEvent(q)},onBlur:function(q){return this.dispatchEvent(q)},redraw:function(){if(!(0<this._redrawCount)){var q=
this._model.getLineCount();this.redrawRulers(0,q);this.redrawLines(0,q)}},redrawRulers:function(q,a){if(!(0<this._redrawCount))for(var d=this.getRulers(),b=0;b<d.length;b++)this.redrawLines(q,a,d[b])},redrawLines:function(q,a,d){if(!(0<this._redrawCount)&&(void 0===q&&(q=0),void 0===a&&(a=this._model.getLineCount()),q!==a)){var b=this._clientDiv;if(b){if(d)for(b=this._getRulerParent(d).firstChild;b&&b._ruler!==d;)b=b.nextSibling;d?b.rulerChanged=!0:this._lineHeight&&this._resetLineHeight(q,a);if(!d||
"page"===d.getOverview())for(b=b.firstChild;b;){var m=b.lineIndex;q<=m&&m<a&&(b.lineChanged=!0);b=b.nextSibling}!d&&(!this._wrapMode&&q<=this._maxLineIndex&&this._maxLineIndex<a)&&(this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0);this._queueUpdate()}}},redrawRange:function(q,a){if(!(0<this._redrawCount)){var d=this._model;void 0===q&&(q=0);void 0===a&&(a=d.getCharCount());var b=d.getLineAtOffset(q),d=d.getLineAtOffset(Math.max(q,a-1))+1;this.redrawLines(b,d)}},
removeKeyMode:function(q){for(var a=this._keyModes,d=0;d<a.length;d++)if(a[d]===q){a.splice(d,1);break}q._modeRemoved&&q._modeRemoved()},removeRuler:function(q){for(var a=this._rulers,d=0;d<a.length;d++)if(a[d]===q){a.splice(d,1);q.setView(null);this._destroyRuler(q);this._update();break}},resize:function(){this._clientDiv&&this._handleResize(null)},setAction:function(q,a,d){if(q){var b=this._actions,m=b[q];m||(m=b[q]={});m.handler=a;void 0!==d&&(m.actionDescription=d)}},setKeyBinding:function(q,
a){this._keyModes[0].setKeyBinding(q,a)},setCaretOffset:function(q,a,d){var b=this._model.getCharCount();q=Math.max(0,Math.min(q,b));q=new u(q,q,!1);this._setSelection(q,void 0===a||a,!0,d)},setHorizontalPixel:function(q){this._clientDiv&&(q=Math.max(0,q),this._scrollView(q-this._getScroll().x,0))},setRedraw:function(q){q?0===--this._redrawCount&&this.redraw():this._redrawCount++},setModel:function(q){if(q&&q!==this._model){this._model.removeEventListener("preChanging",this._modelListener.onChanging);
this._model.removeEventListener("postChanged",this._modelListener.onChanged);var a=this._model.getLineCount(),d=this._model.getCharCount(),b=q.getLineCount(),m=q.getCharCount(),l={type:"ModelChanging",text:q.getText(),start:0,removedCharCount:d,addedCharCount:m,removedLineCount:a,addedLineCount:b};this.onModelChanging(l);this._model=q;l={type:"ModelChanged",start:0,removedCharCount:d,addedCharCount:m,removedLineCount:a,addedLineCount:b};this.onModelChanged(l);this._model.addEventListener("preChanging",
...
a.target?a.target:a.srcElement,b=d.lineIndex;d&&!d._ruler;)void 0===b&&void 0!==d.lineIndex&&(b=d.lineIndex),d=d.parentNode;var m=d?d._ruler:null;if(void 0===b&&m&&"document"===m.getOverview()){var b=this._getClientHeight(),l=this._model.getLineCount(),e=this._getViewPadding(),t=this._viewDiv.getBoundingClientRect(),b=Math.floor((a.clientY-t.top-this._metrics.scrollWidth)*l/(b+e.top+e.bottom-2*this._metrics.scrollWidth));0<=b&&b<l||(b=void 0)}if(m)switch(a.type){case "click":if(m.onClick)m.onClick(b,
...
this._update(b===a.y),this.onScroll({type:"Scroll",oldValue:{x:d,y:b},newValue:a})},_handleSelectStart:function(a){var d=this._contextMenuOpen;this._contextMenuOpen=!1;if(d)this._checkSelectionChange=!0;else if(this._ignoreSelect)return a&&a.preventDefault&&a.preventDefault(),!1},_getModelOffset:function(a,d){if(a){var b;b="DIV"===a.tagName?a:a.parentNode.parentNode;return!b._line?0:b._line.getModelOffset(a,d)}},_updateSelectionFromDOM:function(){if(!g.isOS&&!g.isAndroid&&!this._checkSelectionChange)return!1;
...
d.anchorOffset!==this._anchorOffset||d.focusOffset!==this._focusOffset){for(var b=d.anchorNode;b&&void 0===b.lineIndex;)b=b.parentNode;if(b){var m=this._model,l=b.lineIndex,e=m.getLine(l),t=e,f=0,m=m.getLineStart(l);0<d.rangeCount&&(d.getRangeAt(0).deleteContents(),l=b.ownerDocument.createTextNode(a.data),d.getRangeAt(0).insertNode(l),f=this._getDOMText(b,l),t=f.text,f=f.offset,l.parentNode.removeChild(l));b.lineRemoved=!0;for(b=0;e.charCodeAt(b)===t.charCodeAt(b)&&b<f;)b++;d=e.length-1;for(l=t.length-
e.length;e.charCodeAt(d)===t.charCodeAt(d+l)&&d+l>=f+a.data.length;)d--;d++;e=t.substring(b,d+l);this._ignoreQueueUpdate=g.isSafari;this._modifyContent({text:e,start:b+m,end:d+m,_ignoreDOMSelection:!0,_ignoreDOMSelection1:g.isChrome},!0);this._ignoreQueueUpdate=!1}}else this._doContent(a.data);a.preventDefault()}},_handleTouchStart:function(a){this._commitIME();var d=this._getWindow();this._touchScrollTimer&&(this._vScrollDiv.style.display="none",this._hScrollDiv.style.display="none",d.clearInterval(this._touchScrollTimer),
...
(d=d.match(a),void 0!==d))return this.invokeAction(d);return!1},_doMove:function(a,d){var b=this._model,m=d.getCaret(),l=b.getLineAtOffset(m);a.count||(a.count=1);for(;0!==a.count;){var e=b.getLineStart(l);if(0>a.count&&m===e)if(0<l)"character"===a.unit&&a.count++,l--,d.extend(b.getLineEnd(l));else break;else if(0<a.count&&m===b.getLineEnd(l))if(l+1<b.getLineCount())"character"===a.unit&&a.count--,l++,d.extend(b.getLineStart(l));else break;else{var t=!1;a.expandTab&&("character"===a.unit&&0===(m-
e)%this._tabSize)&&(e=b.getText(e,m),t=!/[^ ]/.test(e));t?(d.extend(m-this._tabSize),a.count+=0>a.count?1:-1):(e=this._getLine(l),d.extend(e.getNextOffset(m,a)),e.destroy())}m=d.getCaret()}return d},_doBackspace:function(a){var d=this._getSelection();d.isEmpty()&&(a.count||(a.count=1),a.count*=-1,a.expandTab=this._expandTab,this._doMove(a,d));this._modifyContent({text:"",start:d.start,end:d.end},!0);return!0},_doCase:function(a){var d=this._getSelection();this._doMove(a,d);var b=this.getText(d.start,
...
b=this._model,m;if(a.ctrl)d.extend(b.getCharCount()),m=function(){};else{var l=d.getCaret(),e=b.getLineAtOffset(l);if(this._wrapMode){var t=this._getLine(e),l=t.getLineIndex(l),l=l===t.getLineCount()-1?b.getLineEnd(e):t.getLineStart(l+1)-1;t.destroy()}else a.count&&0<a.count&&(e=Math.min(e+a.count-1,b.getLineCount()-1)),l=b.getLineEnd(e);d.extend(l)}a.select||d.collapse();this._setSelection(d,!0,!0,m);return!0},_doEnter:function(a){var d=this._model,b=this._getSelection();this._doContent(d.getLineDelimiter());
...
this._getLine(l),t=this._columnX,f=1,u=!1;if(-1===t||a.wholeLine||a.select&&g.isIE)t=a.wholeLine?d.getLineEnd(l+1):m,t=e.getBoundingClientRect(t).left;(m=e.getLineIndex(m))<e.getLineCount()-1?f=e.getClientRects(m+1).top+1:(m=d.getLineCount()-1,u=l===m,a.count&&0<a.count?l=Math.min(l+a.count,m):l++);m=!1;if(u){if(a.select||g.isMac||g.isLinux)b.extend(d.getCharCount()),m=!0}else e.lineIndex!==l&&(e.destroy(),e=this._getLine(l)),b.extend(e.getOffset(t,f)),m=!0;m&&(a.select||b.collapse(),this._setSelection(b,
!0,!0));this._columnX=t;e.destroy();return!0},_doLineUp:function(a){var d=this._model,b=this._getSelection(),m=b.getCaret(),l=d.getLineAtOffset(m),e=this._getLine(l),t=this._columnX,f=!1,u;if(-1===t||a.wholeLine||a.select&&g.isIE)t=a.wholeLine?d.getLineStart(l-1):m,t=e.getBoundingClientRect(t).left;0<(m=e.getLineIndex(m))?u=e.getClientRects(m-1).top+1:(f=0===l,f||(a.count&&0<a.count?l=Math.max(l-a.count,0):l--,u=this._getLineHeight(l)-1));m=!1;if(f){if(a.select||g.isMac||g.isLinux)b.extend(0),m=!0}else e.lineIndex!==
l&&(e.destroy(),e=this._getLine(l)),b.extend(e.getOffset(t,u)),m=!0;m&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=t;e.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var d=this,b=this._model,m=this._getSelection(),l=m.getCaret(),e=b.getLineAtOffset(l),t=b.getLineCount(),f=this._getScroll(),b=this._getClientHeight(),u,h;if(this._lineHeight){u=this._columnX;f=this._getBoundsAtOffset(l);if(-1===u||a.select&&g.isIE)u=f.left;l=this._getLineIndex(f.top+b);
h=this._getLine(l);e=this._getLinePixel(l);l=h.getOffset(u,f.top+b-e);b=h.getBoundingClientRect(l);h.destroy();m.extend(l);a.select||m.collapse();this._setSelection(m,!0,!0,function(){d._columnX=u},b.top+e-f.top);return!0}if(e<t-1){var p=this._getLineHeight(),v=Math.min(t-e-1,Math.floor(b/p)),v=Math.max(1,v);u=this._columnX;if(-1===u||a.select&&g.isIE)h=this._getLine(e),u=h.getBoundingClientRect(l).left,h.destroy();h=this._getLine(e+v);m.extend(h.getOffset(u,0));h.destroy();a.select||m.collapse();
a=t*p;l=f.y+v*p;l+b>a&&(l=a-b);this._setSelection(m,!0,!0,function(){d._columnX=u},l-f.y)}return!0},_doPageUp:function(a){var d=this,b=this._model,m=this._getSelection(),l=m.getCaret(),e=b.getLineAtOffset(l),t=this._getScroll(),f=this._getClientHeight(),u;if(this._lineHeight){u=this._columnX;t=this._getBoundsAtOffset(l);if(-1===u||a.select&&g.isIE)u=t.left;l=this._getLineIndex(t.bottom-f);b=this._getLine(l);e=this._getLinePixel(l);l=b.getOffset(u,t.bottom-f-e);f=b.getBoundingClientRect(l);b.destroy();
m.extend(l);a.select||m.collapse();this._setSelection(m,!0,!0,function(){d._columnX=u},f.top+e-t.top);return!0}if(0<e){var h=this._getLineHeight(),f=Math.max(1,Math.min(e,Math.floor(f/h)));u=this._columnX;if(-1===u||a.select&&g.isIE)b=this._getLine(e),u=b.getBoundingClientRect(l).left,b.destroy();b=this._getLine(e-f);m.extend(b.getOffset(u,this._getLineHeight(e-f)-1));b.destroy();a.select||m.collapse();a=Math.max(0,t.y-f*h);this._setSelection(m,!0,!0,function(){d._columnX=u},a-t.y)}return!0},_doPaste:function(a){var d=
this;return null!==this._getClipboardText(a,function(a){a&&(g.isLinux&&2===d._lastMouseButton&&(new Date).getTime()-d._lastMouseTime<=d._clickTime&&d._setSelectionTo(d._lastMouseX,d._lastMouseY),d._doContent(a))})},_doScroll:function(a){var d=a.type,b=this._model,m=b.getLineCount();a=this._getClientHeight();var l=this._getLineHeight(),m=m*l,e=this._getScroll().y,t;switch(d){case "textStart":t=0;break;case "textEnd":t=m-a;break;case "pageDown":t=e+a;break;case "pageUp":t=e-a;break;case "lineDown":t=
e+l;break;case "lineUp":t=e-l;break;case "centerLine":d=this._getSelection(),t=b.getLineAtOffset(d.start),b=(b.getLineAtOffset(d.end)-t+1)*l,t=t*l-a/2+b/2}void 0!==t&&(t=Math.min(Math.max(0,t),m-a),this._scrollViewAnimated(0,t-e,function(){}));return!0},_doSelectAll:function(a){a=this._model;var d=this._getSelection();d.setCaret(0);d.extend(a.getCharCount());this._setSelection(d,!1);return!0},_doTab:function(a){if(this._tabMode&&!this._readonly){a="\t";if(this._expandTab){var d=this._model;a=this._getSelection().getCaret();
...
this._model,d=this._getSelection(),b=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),m=d.getCaret(),l=a.getLineCount(),e=a.getLineAtOffset(m),t;if("up"===this._autoScrollDir||"down"===this._autoScrollDir)m=this._autoScrollY/this._getLineHeight(),m=0>m?Math.floor(m):Math.ceil(m),t=Math.max(0,Math.min(l-1,e+m));else if("left"===this._autoScrollDir||"right"===this._autoScrollDir)t=this._getLineIndex(b.y),e=this._getLine(e),b.x+=e.getBoundingClientRect(m,!1).left,e.destroy();
0===t&&(g.isMac||g.isLinux)?d.extend(0):t===l-1&&(g.isMac||g.isLinux)?d.extend(a.getCharCount()):(e=this._getLine(t),d.extend(e.getOffset(b.x,b.y-this._getLinePixel(t))),e.destroy());this._setSelection(d,!0)},_autoScrollTimer:function(){this._autoScroll();var a=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){a._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(a){if(this._lineHeight&&!this._calculateLHTimer){var d=this._model.getLineCount(),b=0;if(a){a=
...
u=u.bottom-u.top,v=l.bottom-l.top,k=0,l=0>=h.bottom-h.top,h=Math.max(1,h.bottom-h.top);f>e&&(k=1);u>f&&(k=2);v>u&&(k=3);var A;0!==k&&(A={style:{}},0!==(k&1)&&(A.style.fontStyle="italic"),0!==(k&2)&&(A.style.fontWeight="bold"));e=t(b);a.removeChild(b);v=m(this._viewDiv);b=g.createElement(d,"div");b.style.position="fixed";b.style.left="-1000px";b.style.paddingLeft=v.left+"px";b.style.paddingTop=v.top+"px";b.style.paddingRight=v.right+"px";b.style.paddingBottom=v.bottom+"px";b.style.width="100px";b.style.height=
...
this._themeListener.onChanged);var d=this._handlers=[],b=this._clientDiv,m=this._viewDiv,l=this._rootDiv,e=this._overlayDiv||b,t=b.ownerDocument,f=this._getWindow(),u=g.isIE?t:f;d.push({target:f,type:"resize",handler:function(d){return a._handleResize(d?d:f.event)}});d.push({target:b,type:"blur",handler:function(d){return a._handleBlur(d?d:f.event)}});d.push({target:b,type:"focus",handler:function(d){return a._handleFocus(d?d:f.event)}});d.push({target:m,type:"focus",handler:function(a){b.focus()}});
d.push({target:m,type:"scroll",handler:function(d){return a._handleScroll(d?d:f.event)}});d.push({target:b,type:"textInput",handler:function(d){return a._handleTextInput(d?d:f.event)}});d.push({target:b,type:"keydown",handler:function(d){return a._handleKeyDown(d?d:f.event)}});d.push({target:b,type:"keypress",handler:function(d){return a._handleKeyPress(d?d:f.event)}});d.push({target:b,type:"keyup",handler:function(d){return a._handleKeyUp(d?d:f.event)}});g.isIE&&d.push({target:t,type:"keyup",handler:function(d){return a._handleDocKeyUp(d?
d:f.event)}});d.push({target:b,type:"contextmenu",handler:function(d){return a._handleContextMenu(d?d:f.event)}});d.push({target:b,type:"copy",handler:function(d){return a._handleCopy(d?d:f.event)}});d.push({target:b,type:"cut",handler:function(d){return a._handleCut(d?d:f.event)}});d.push({target:b,type:"paste",handler:function(d){return a._handlePaste(d?d:f.event)}});d.push({target:t,type:"selectionchange",handler:function(d){return a._handleSelectionChange(d?d:f.event)}});if(g.isIOS||g.isAndroid)d.push({target:b,
...
this.onModelChanged(a);a.type="Changed";var d=a.start,b=a.addedCharCount,m=a.removedCharCount,l=a.addedLineCount,e=a.removedLineCount,t=this._getSelection();t.end>d&&(t.end>d&&t.start<d+m?t.setCaret(d+b):(t.start+=b-m,t.end+=b-m),this._setSelection(t,!1,!1));d=this._model.getLineAtOffset(d);for(b=this._getLineNext();b;)m=b.lineIndex,d<=m&&m<=d+e&&(d===m&&!b.modelChangedEvent&&!b.lineRemoved?(b.modelChangedEvent=a,b.lineChanged=!0):(b.lineRemoved=!0,b.lineChanged=!1,b.modelChangedEvent=null)),m>d+
...
m.moveStart("character",a.offset),l=l.createTextRange(),l.moveToElementText(b.node.parentNode),l.moveStart("character",b.offset),m.setEndPoint("EndToStart",l),this._ignoreSelect=!1,m.select(),this._ignoreSelect=!0)},_setDOMFullSelection:function(a,d,b,m){if(this._selDiv1){var l=this._selDiv1;l.style.width="0px";l.style.height="0px";l=this._selDiv2;l.style.width="0px";l.style.height="0px";l=this._selDiv3;l.style.width="0px";l.style.height="0px";if(!(a===b&&d===m)){var e=this._getViewPadding(),t=this._clientDiv.getBoundingClientRect(),
f=this._viewDiv.getBoundingClientRect(),l=f.left+e.left,g=t.right,e=f.top+e.top,u=t.bottom,f=t=0;this._clipDiv?(f=this._clipDiv.getBoundingClientRect(),t=f.left-this._clipDiv.scrollLeft):(f=this._rootDiv.getBoundingClientRect(),t=f.left);f=f.top;this._ignoreDOMSelection=!0;var h=(new A(this,a.lineIndex,a)).getBoundingClientRect(d,!1),p=h.left;d=(new A(this,b.lineIndex,b)).getBoundingClientRect(m,!1);var v=d.left;this._ignoreDOMSelection=!1;var k=this._selDiv1,p=Math.min(g,Math.max(l,p)),w=Math.min(u,
Math.max(e,h.top)),n=g;m=Math.min(u,Math.max(e,h.bottom));k.style.left=p-t+"px";k.style.top=w-f+"px";k.style.width=Math.max(0,n-p)+"px";k.style.height=Math.max(0,m-w)+"px";a.lineIndex===b.lineIndex?(n=Math.min(v,g),k.style.width=Math.max(0,n-p)+"px"):(h=Math.min(u,Math.max(e,d.top)),v=Math.min(g,Math.max(l,v)),e=Math.min(u,Math.max(e,d.bottom)),u=this._selDiv3,u.style.left=l-t+"px",u.style.top=h-f+"px",u.style.width=Math.max(0,v-l)+"px",u.style.height=Math.max(0,e-h)+"px",1<Math.abs(a.lineIndex-b.lineIndex)&&
(a=this._selDiv2,a.style.left=l-t+"px",a.style.top=m-f+"px",a.style.width=Math.max(0,g-l)+"px",a.style.height=Math.max(0,h-m)+"px"))}}},_setGrab:function(a){a!==this._grabControl&&(a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null))},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;g.isIE&&a&&(this._hadFocus=this._hasFocus);var d=this._clientDiv;d.contentEditable=!a;this._hadFocus&&
...
"pre-wrap",b.style.wordWrap="break-word"):(b.style.whiteSpace="pre",b.style.wordWrap="normal");this._updateOverflow();d||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},_showCaret:function(a,d,b,m){if(this._clientDiv&&!(0<this._redrawCount)&&!this._ignoreDOMSelection){var l=this._model,e=this._getSelection(),t=this._getScroll(),f=e.getCaret(),g=e.start,u=e.end,h=l.getLineAtOffset(g),p=l.getLineAtOffset(u),v=Math.max(Math.max(g,l.getLineStart(p)),u-1),l=this._getClientWidth(),k=this._getClientHeight(),
A=l/4,w=this._getBoundsAtOffset(f===g?g:v),n=w.left,r=w.right,y=w.top,s=w.bottom,x=0,D="object"===typeof b;if((a||D)&&!e.isEmpty())w=this._getBoundsAtOffset(f===u?g:v),x=(w.bottom>s?w.bottom:s)-(w.top<y?w.top:y),a&&(w.top===y?f===g?r=n+Math.min(w.right-n,l):n=r-Math.min(r-w.left,l):f===g?s=y+Math.min(w.bottom-y,k):y=s-Math.min(s-w.top,k));a=0;n<t.x&&(a=Math.min(n-t.x,-A));r>t.x+l&&(a=Math.max(r-t.x-l,A));e=0;y<t.y?e=y-t.y:s>t.y+k&&(e=s-t.y-k);m&&(0<m?0<e&&(e=Math.max(e,m)):0>e&&(e=Math.min(e,m)));
m=D&&"always"===b.scrollPolicy;if(0!==a||0!==e||m)return D?(m=0<e,0===e&&(e=y-t.y),t=b.viewAnchor,y=b.selectionAnchor,b=Math.min(Math.max(0,b.viewAnchorOffset||0)),e="top"===t?e+Math.floor(m?(1-b)*k:-b*k):"bottom"===t?e+Math.floor(m?b*k:-(1-b)*k):"center"===t?e+Math.floor(m?k/2+b*k:k/2-(1-b)*k):e+Math.floor(m?b*k:-b*k),h!==p&&("top"===y&&f!==g?e+=Math.floor(-x):"bottom"===y&&f!==u?e+=Math.floor(x):"center"===y&&(e+=Math.floor(x/2)))):0!==e&&"number"===typeof b&&(0>b&&(b=0),1<b&&(b=1),e+=Math.floor(0<
...
l=this._getLineNext();if(l){var e=this._getLinePrevious(),t;b<l.lineIndex?(b=l,t=d.getLineStart(l.lineIndex)):b>e.lineIndex?(b=e,t=d.getLineStart(e.lineIndex)):(b=this._getLineNode(b),t=a.start);m<l.lineIndex?(m=l,d=d.getLineStart(l.lineIndex)):m>e.lineIndex?(m=e,d=d.getLineStart(e.lineIndex)):(m=this._getLineNode(m),d=a.end);this._setDOMSelection(b,t,m,d,a.caret)}}},_update:function(a){if(!(0<this._redrawCount)){this._updateTimer&&(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=
null,a=!1);var d=this._clientDiv,b=this._viewDiv;if(d){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var m=this._model,l=this._getScroll(!1),e=this._getViewPadding(),t=m.getLineCount(),f=this._getLineHeight(),u=!1,h=!1,p=!1,v=this._metrics.scrollWidth;this._wrapMode&&(d.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var k,w,n,r,y=0,s=0,x;if(this._lineHeight){for(;s<t;){x=this._getLineHeight(s);if(y+x>l.y)break;y+=x;s++}k=s;
...
w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=F),f.destroy()));for(;s<t;)x=this._getLineHeight(s,s<=n),y+=x,s++;t=y;this._updateRuler(this._leftDiv,k,l,K);this._updateRuler(this._rightDiv,k,l,K);this._updateRuler(this._marginDiv,k,l,K);f=0;this._leftDiv&&(k=this._leftDiv.getBoundingClientRect(),f=k.right-k.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-l.left);b.style.left=f+"px";b.style.right=l+"px";l=this._scrollDiv;l.style.height=t+"px";k=this._getClientWidth();
!this._singleMode&&!this._wrapMode&&(y=u=r,(s="scroll"===b.style.overflowX)?u+=v:y-=v,x=n=k,(w="scroll"===b.style.overflowY)?n+=v:x-=v,r=u,k=n,t>r&&(p=!0,k=x),this._maxLineWidth>k&&(h=!0,r=y,t>r&&(p=!0,k=x)),s!==h&&(b.style.overflowX=h?"scroll":"hidden"),w!==p&&(b.style.overflowY=p?"scroll":"hidden"),u=s!==h||w!==p);p=k;this._wrapMode?this._metrics.wrapWidth&&(p=this._metrics.wrapWidth):p=Math.max(this._maxLineWidth,p);h=p;if((!g.isIE||9<=g.isIE)&&this._maxLineWidth>k)p+=e.right+e.left;l.style.width=
p+"px";this._clipScrollDiv&&(this._clipScrollDiv.style.width=p+"px");l=this._getScroll(!1)}this._vScrollDiv&&(p=r-8,y=Math.max(15,Math.ceil(Math.min(1,p/(t+e.top+e.bottom))*p)),this._vScrollDiv.style.left=f+k-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*p/t))+"px",this._vScrollDiv.style.height=y+"px");!this._wrapMode&&this._hScrollDiv&&(p=k-8,y=Math.max(15,Math.ceil(Math.min(1,p/(this._maxLineWidth+e.left+e.right))*p)),this._hScrollDiv.style.left=f+Math.floor(Math.max(0,Math.floor(l.x*
p/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=r-9+"px",this._hScrollDiv.style.width=y+"px");s=l.x;y=this._clipDiv;p=this._overlayDiv;if(n=this._marginDiv)n.style.left=-s+f+this._metrics.marginWidth+e.left+"px",n.style.bottom=("scroll"===b.style.overflowX?v:0)+"px";y?(y.scrollLeft=s,y.scrollTop=0,b=f+e.left,v=e.top,a=k,f=r,s=0,n=-m,0===l.x&&(b-=e.left,a+=e.left,s=e.left),l.x+k===h&&(a+=e.right),0===l.y&&(v-=e.top,f+=e.top,n+=e.top),l.y+r===t&&(f+=e.bottom),y.style.left=b+"px",y.style.top=
v+"px",y.style.right=D-a-b+"px",y.style.bottom=K-f-v+"px",d.style.left=s+"px",d.style.top=n+"px",d.style.width=h+"px",d.style.height=r+m+"px",p&&(p.style.left=d.style.left,p.style.top=d.style.top,p.style.width=d.style.width,p.style.height=d.style.height)):(b=s,v=m,D=s+k,K=m+r,0===b&&(b-=e.left),0===v&&(v-=e.top),D===h&&(D+=e.right),l.y+r===t&&(K+=e.bottom),d.style.clip="rect("+v+"px,"+D+"px,"+K+"px,"+b+"px)",d.style.left=-s+f+e.left+"px",d.style.width=(this._wrapMode||g.isWebkit?h:k+s)+"px",a||(d.style.top=
...
this._parent.ownerDocument,e=this._getLineHeight(),t=this._getViewPadding();for(a=a.firstChild;a;){var f=a._ruler,u=e,h=f.getOverview();"page"===h&&(u+=this._topIndexY);a.style.top=-u+"px";a.style.height=m+u+"px";a.rulerChanged&&p(f.getRulerStyle(),a);var v,k=a.firstChild;k?(v=k,k=k.nextSibling):(v=g.createElement(l,"div"),v.style.visibility="hidden",a.appendChild(v));var A;if(a.rulerChanged&&v){u=-1;if(A=f.getWidestAnnotation())p(A.style,v),A.html&&(v.innerHTML=A.html);v.lineIndex=u;v.style.height=
e+t.top+"px"}var w;if("page"===h){for(f=f.getAnnotations(d,b+1);k;)u=k.lineIndex,A=k.nextSibling,(!(d<=u&&u<=b)||k.lineChanged)&&a.removeChild(k),k=A;k=a.firstChild.nextSibling;w=l.createDocumentFragment();for(u=d;u<=b;u++)if(!k||k.lineIndex>u){v=g.createElement(l,"div");if(A=f[u])p(A.style,v),A.html&&(v.innerHTML=A.html),v.annotation=A;v.lineIndex=u;v.style.height=this._getLineHeight(u)+"px";w.appendChild(v)}else w.firstChild&&(a.insertBefore(w,k),w=l.createDocumentFragment()),k&&(k=k.nextSibling);
w.firstChild&&a.insertBefore(w,k)}else{A=this._getClientHeight();u=this._model.getLineCount();k=A+t.top+t.bottom-2*this._metrics.scrollWidth;h=e*u<k?e:k/u;if(a.rulerChanged){for(A=a.childNodes.length;1<A;)a.removeChild(a.lastChild),A--;f=f.getAnnotations(0,u);w=l.createDocumentFragment();for(var n in f)u=n>>>0,0>u||(v=g.createElement(l,"div"),A=f[n],p(A.style,v),v.style.position="absolute",v.style.top=this._metrics.scrollWidth+e+Math.floor(u*h)+"px",A.html&&(v.innerHTML=A.html),v.annotation=A,v.lineIndex=
...
define("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(n,s){function r(k){this._model=k;this._projections=[];var f=this;this._listener={onChanged:function(h){f._onChanged(h)},onChanging:function(h){f._onChanging(h)}};k.addEventListener("postChanged",this._listener.onChanged);k.addEventListener("preChanging",this._listener.onChanging)}r.prototype={destroy:function(){this._model&&(this._model.removeEventListener("postChanged",this._listener.onChanged),
...
e._model.getCharCount()-(e.end-e.start)}return k+g}for(p=0;p<h.length;p++){e=h[p];if(e.start>k-g)break;var b=e._model.getCharCount();if(e.start+b>k-g)return-1;g+=b-(e.end-e.start)}return k-g},removeProjection:function(k){var f,h=0;for(f=0;f<this._projections.length;f++){var g=this._projections[f];if(g===k){k=g;break}h+=g._model.getCharCount()-(g.end-g.start)}if(f<this._projections.length){var g=this._model,h=k.start+h,p=k.end-k.start,e=k._lineCount,b=k._model.getCharCount(),a=k._model.getLineCount()-
1;k={type:"Changing",text:g.getText(k.start,k.end),start:h,removedCharCount:b,addedCharCount:p,removedLineCount:a,addedLineCount:e};this.onChanging(k);this._projections.splice(f,1);this.onChanged({type:"Changed",start:h,removedCharCount:b,addedCharCount:p,removedLineCount:a,addedLineCount:e})}},_binarySearch:function(k,f){for(var h=k.length,g=-1,p;1<h-g;)p=Math.floor((h+g)/2),f<=k[p].start?h=p:g=p;return h},getCharCount:function(){for(var k=this._model.getCharCount(),f=this._projections,h=0;h<f.length;h++)var g=
f[h],k=k+(g._model.getCharCount()-(g.end-g.start));return k},getLine:function(k,f){if(0>k)return null;var h=this._model,g=this._projections,p=0,e=[],b=0,a,d,m;for(a=0;a<g.length;a++){m=g[a];if(m._lineIndex>=k-p)break;d=m._model.getLineCount()-1;if(m._lineIndex+d>=k-p){b=k-(m._lineIndex+p);if(b<d)return m._model.getLine(b,f);e.push(m._model.getLine(d))}b=m.end;p+=d-m._lineCount}for(b=Math.max(b,h.getLineStart(k-p));a<g.length;a++){m=g[a];if(m._lineIndex>k-p)break;e.push(h.getText(b,m.start));d=m._model.getLineCount()-
1;if(m._lineIndex+d>k-p)return e.push(m._model.getLine(0,f)),e.join("");e.push(m._model.getText());b=m.end;p+=d-m._lineCount}g=h.getLineEnd(k-p,f);b<g&&e.push(h.getText(b,g));return e.join("")},getLineAtOffset:function(k){for(var f=this._model,h=this._projections,g=0,p=0,e=0;e<h.length;e++){var b=h[e];if(b.start>k-g)break;var a=b._model.getCharCount();if(b.start+a>k-g){h=k-(b.start+g);p+=b._model.getLineAtOffset(h);g+=h;break}p+=b._model.getLineCount()-1-b._lineCount;g+=a-(b.end-b.start)}return f.getLineAtOffset(k-
g)+p},getLineCount:function(){for(var k=this._projections,f=this._model.getLineCount(),h=0;h<k.length;h++)var g=k[h],f=f+(g._model.getLineCount()-1-g._lineCount);return f},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(k,f){if(0>k)return-1;for(var h=this._model,g=this._projections,p=0,e=0,b=0;b<g.length;b++){var a=g[b];if(a._lineIndex>k-p)break;var d=a._model.getLineCount()-1;if(a._lineIndex+d>k-p)return a._model.getLineEnd(k-(a._lineIndex+p),f)+a.start+e;e+=
a._model.getCharCount()-(a.end-a.start);p+=d-a._lineCount}return h.getLineEnd(k-p,f)+e},getLineStart:function(k){if(0>k)return-1;for(var f=this._model,h=this._projections,g=0,p=0,e=0;e<h.length;e++){var b=h[e];if(b._lineIndex>=k-g)break;var a=b._model.getLineCount()-1;if(b._lineIndex+a>=k-g)return b._model.getLineStart(k-(b._lineIndex+g))+b.start+p;p+=b._model.getCharCount()-(b.end-b.start);g+=a-b._lineCount}return f.getLineStart(k-g)+p},getText:function(k,f){void 0===k&&(k=0);var h=this._model,g=
this._projections,p=0,e=[],b,a,d;for(b=0;b<g.length;b++){a=g[b];if(a.start>k-p)break;d=a._model.getCharCount();if(a.start+d>k-p){if(void 0!==f&&a.start+d>f-p)return a._model.getText(k-(a.start+p),f-(a.start+p));e.push(a._model.getText(k-(a.start+p)));k=a.end+p+d-(a.end-a.start)}p+=d-(a.end-a.start)}var m=k-p;if(void 0!==f){for(;b<g.length;b++){a=g[b];if(a.start>f-p)break;e.push(h.getText(m,a.start));d=a._model.getCharCount();if(a.start+d>f-p)return e.push(a._model.getText(0,f-(a.start+p))),e.join("");
e.push(a._model.getText());m=a.end;p+=d-(a.end-a.start)}e.push(h.getText(m,f-p))}else{for(;b<g.length;b++)a=g[b],e.push(h.getText(m,a.start)),e.push(a._model.getText()),m=a.end;e.push(h.getText(m))}return e.join("")},_onChanged:function(k){k=this._change;var f=k.baseStart,h=k.baseEnd,g,p,e=this._projections;for(g=0;g<e.length&&!(p=e[g],p.end>f);g++);var b=g;for(g=0;g<e.length&&!(p=e[g],p.start>=h);g++);var a=g,d=this._model,f=k.baseText.length-(h-f);for(g=a;g<e.length;g++)p=e[g],p.start+=f,p.end+=
f,p._lineIndex=d.getLineAtOffset(p.start);p=e.splice(b,a-b);for(g=0;g<p.length;g++)p[g].annotation&&p[g].annotation._expand();this.onChanged({type:"Changed",start:k.start,removedCharCount:k.removedCharCount,addedCharCount:k.addedCharCount,removedLineCount:k.removedLineCount,addedLineCount:k.addedLineCount});this._change=void 0},_onChanging:function(k){var f=!!this._change,h=this._change||{},g=k.start,p=g+k.removedCharCount;h.baseStart=g;h.baseEnd=p;h.baseText=k.text;h.addedLineCount=k.addedLineCount;
if(!f){this._change=h;h.text=k.text;var e=this._projections,b,a,d;k=function(m){for(b=a=0;a<e.length;a++){d=e[a];if(d.start>m)break;if(d.end>m)return-1;b+=d._model.getCharCount()-(d.end-d.start)}return m+b};h.start=k(g);-1===h.start&&(h.text=this._model.getText(d.start,g)+h.text,h.addedLineCount+=this._model.getLineAtOffset(g)-this._model.getLineAtOffset(d.start),h.start=d.start+b);h.end=k(p);-1===h.end&&(h.text+=this._model.getText(p,d.end),h.addedLineCount+=this._model.getLineAtOffset(d.end)-this._model.getLineAtOffset(p),
h.end=d.start+b)}h.addedCharCount=h.text.length;h.removedCharCount=h.end-h.start;h.removedLineCount=this.getLineAtOffset(h.end)-this.getLineAtOffset(h.start);this.onChanging({type:"Changing",text:h.text,start:h.start,removedCharCount:h.removedCharCount,addedCharCount:h.addedCharCount,removedLineCount:h.removedLineCount,addedLineCount:h.addedLineCount})},onChanging:function(k){return this.dispatchEvent(k)},onChanged:function(k){return this.dispatchEvent(k)},setLineDelimiter:function(k){this._model.setLineDelimiter(k)},
setText:function(k,f,h){function g(d){for(e=b=0;b<p.length;b++){a=p[b];if(a.start>d-e)break;var m=a._model.getCharCount();if(a.start+m>d-e)return-1;e+=m-(a.end-a.start)}return d-e}this._change={text:k||"",start:f||0,end:void 0===h?this.getCharCount():h};var p=this._projections,e,b,a,d,m;k=g(this._change.start);-1===k&&(d={projection:a,start:this._change.start-(a.start+e)},k=a.end);f=g(this._change.end);-1===f&&(m={projection:a,end:this._change.end-(a.start+e)},f=a.start);d&&m&&d.projection===m.projection?
a._model.setText(this._change.text,d.start,m.end):(this._model.setText(this._change.text,k,f),d&&(a=d.projection,a._model.setText("",d.start)),m&&(a=m.projection,a._model.setText("",0,m.end),a.start=a.end,a._lineCount=0));this._change=void 0}};s.EventTarget.addMixin(r.prototype);return{ProjectionTextModel:r}});
define("orion/editor/annotations",["i18n!orion/editor/nls/messages","orion/editor/eventTarget"],function(n,s){function r(){}function k(a,d,b){this.start=a;this.end=d;this._projectionModel=b;this.html=this._expandedHTML;this.style=this._expandedStyle;this.expanded=!0}function f(a,d){var b=a.lastIndexOf("."),b=a.substring(b+1),e={title:n[b],style:{styleClass:"annotation "+b},html:"\x3cdiv class\x3d'annotationHTML "+b+"'\x3e\x3c/div\x3e",overviewStyle:{styleClass:"annotationOverview "+b}};d?e.lineStyle=
...
(a._expandImpl(!1),a._recollapse=!0)});a=this._projectionModel;var d=a.getBaseModel();this._projection={annotation:this,start:d.getLineStart(d.getLineAtOffset(this.start)+1),end:d.getLineEnd(d.getLineAtOffset(this.end),!0)};a.addProjection(this._projection)}},_expandImpl:function(a){this._expand()&&(this._projectionModel.removeProjection(this._projection),a&&this._forEachOverlaping(function(a){a._recollapse&&(a._collapseImpl(!1),a._recollapse=!1)}))},_forEachOverlaping:function(a){if(this._annotationModel)for(var d=
...
f=d+e;if(0<l.length){a={type:"Changed",added:[],removed:[],changed:[],textModelChangedEvent:a};b-=e;for(e=0;e<l.length;e++){var g=l[e];g.start>=f?(g._oldStart=g.start,g._oldEnd=g.end,g.start+=b,g.end+=b,a.changed.push(g)):g.end<=d||(g.start<d&&f<g.end?(g._oldStart=g.start,g._oldEnd=g.end,g.end+=b,a.changed.push(g)):(l.splice(e,1),a.removed.push(g),g._annotationModel=null,g.expand&&g.expand(),e--))}if(0<a.added.length||0<a.removed.length||0<a.changed.length)this.onChanged(a)}}};s.EventTarget.addMixin(p.prototype);
...
d;else if(this._isNode(d))a.appendChild(d);else if(d instanceof k.ProjectionTextModel){var m=this._view,t=m.getOptions();t.wrapMode=!1;t.parent=a;var l=t.themeClass;l?((l=l.replace("tooltipTheme",""))&&(l=" "+l),l="tooltipTheme"+l):l="tooltipTheme";t.themeClass=l;t=this._contentsView=new s.TextView(t);t.addEventListener("LineStyle",function(a){m.onLineStyle(a)});t.setModel(d);d=t.computeSize();a.style.width=d.width+"px";a.style.height=d.height+"px";t.resize()}else return;a=b.ownerDocument.documentElement;
...
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(n,s,r,k){function f(b,a,d,m){this._location=a||"left";this._overview=d||"page";this._rulerStyle=m;this._view=null;var e=this;this._listener={onTextModelChanged:function(a){e._onTextModelChanged(a)},onAnnotationModelChanged:function(a){e._onAnnotationModelChanged(a)}};this.setAnnotationModel(b)}function h(b,a,d,m,e){f.call(this,b,a,"page",d);this._oddStyle=m||{style:{backgroundColor:"white"}};
...
define("orion/editor/textDND",["orion/util"],function(n){function s(n,k){this._view=n;this._undoStack=k;this._dragSelection=null;this._dropOffset=-1;this._dropText=null;var f=this;this._listener={onDragStart:function(h){f._onDragStart(h)},onDragEnd:function(h){f._onDragEnd(h)},onDragEnter:function(h){f._onDragEnter(h)},onDragOver:function(h){f._onDragOver(h)},onDrop:function(h){f._onDrop(h)},onDestroy:function(h){f._onDestroy(h)}};n.addEventListener("DragStart",this._listener.onDragStart);n.addEventListener("DragEnd",
this._listener.onDragEnd);n.addEventListener("DragEnter",this._listener.onDragEnter);n.addEventListener("DragOver",this._listener.onDragOver);n.addEventListener("Drop",this._listener.onDrop);n.addEventListener("Destroy",this._listener.onDestroy)}s.prototype={destroy:function(){var n=this._view;n&&(n.removeEventListener("DragStart",this._listener.onDragStart),n.removeEventListener("DragEnd",this._listener.onDragEnd),n.removeEventListener("DragEnter",this._listener.onDragEnter),n.removeEventListener("DragOver",
...
m=b.mapOffset(m.getLineEnd(a)),g=l.getAnnotations(f,m),t=null;g.hasNext();){var h=g.next();if(h.type===e.ANNOTATION_BOOKMARK){t=h;break}}t?l.removeAnnotation(t):(t=e.createAnnotation(e.ANNOTATION_BOOKMARK,f,m),t.title=void 0,l.addAnnotation(t))}};if(this._annotationFactory){var f=a.getModel();f.getBaseModel&&(f=f.getBaseModel());if(this._annotationModel=this._annotationFactory.createAnnotationModel(f))if(f=this._annotationStyler=this._annotationFactory.createAnnotationStyler(a,this._annotationModel))f.addAnnotationType(e.ANNOTATION_CURRENT_SEARCH),
...
this._textView=this._undoStack=this._textDND=this._contentAssist=this._listener=this._annotationModel=this._annotationStyler=this._annotationRuler=this._overviewRuler=this._lineNumberRuler=this._foldingRuler=this._currentLineAnnotation=this._title=null,this._dirty=!1,this._foldingRulerVisible=this._overviewRulerVisible=this._lineNumberRulerVisible=this._annotationRulerVisible=void 0,this.dispatchEvent({type:"TextViewUninstalled",textView:b}),g.prototype.uninstall.call(this))},_updateCursorStatus:function(){for(var b=
this.getModel(),a=this.getCaretOffset(),d=b.getLineAtOffset(a),b=b.getLineStart(d),a=a-b,b=this.getKeyModes(),e=0;e<b.length;e++){var f=b[e];if(f.isActive()&&f.isStatusActive&&f.isStatusActive())return}this.reportStatus(h.formatMessage(n.lineColumn,d+1,a+1))},showAnnotations:function(b,a,d,m){var f=this._annotationModel;if(f){for(var l=[],g=[],h=f.getTextModel(),p=f.getAnnotations(),k;p.hasNext();)k=p.next(),-1!==a.indexOf(k.type)&&k.creatorID===this&&l.push(k);if(b)for(a=0;a<b.length;a++)if(k=b[a]){if(d)k=
d(k);else{var n;"number"===typeof k.line?(n=h.getLineStart(k.line-1),p=n+k.start-1,n=n+k.end-1):(p=k.start,n=k.end);var r=m(k);if(!r)continue;k=e.createAnnotation(r,p,n,k.description)}k.creatorID=this;g.push(k)}f.replaceAnnotations(l,g)}},showProblems:function(b){this.showAnnotations(b,[e.ANNOTATION_ERROR,e.ANNOTATION_WARNING,e.ANNOTATION_TASK],null,function(a){switch(a.severity){case "error":return e.ANNOTATION_ERROR;case "warning":return e.ANNOTATION_WARNING;case "task":return e.ANNOTATION_TASK}return null})},
showOccurrences:function(b){this.showAnnotations(b,[e.ANNOTATION_READ_OCCURRENCE,e.ANNOTATION_WRITE_OCCURRENCE],null,function(a){return a.readAccess?e.ANNOTATION_READ_OCCURRENCE:e.ANNOTATION_WRITE_OCCURRENCE})},showBlame:function(b){var a=this._blameRGB,d=this.getTextView().getOptions("parent").ownerDocument;if(!a){var m=h.createElement(d,"div");m.className="annotation blame";d.body.appendChild(m);var g=(d.defaultView||d.parentWindow).getComputedStyle(m).getPropertyValue("background-color");m.parentNode.removeChild(m);
var m=g.indexOf("("),l=g.indexOf(")"),g=g.substring(m+1,l);this._blameRGB=a=g.split(",").slice(0,3)}var u=function(){var a=k.AnnotationType.createAnnotation(this.groupType,this.start,this.end,this.title);a.style=f.mixin({},a.style);a.style.style=f.mixin({},a.style.style);a.style.style.backgroundColor="";this.groupAnnotation=a;a.blame=this.blame;a.html=this.html;a.creatorID=this.creatorID;return a},p=function(){var a=h.createElement(d,"div");a.className="tooltipTitle";var b=this.blame.Message.indexOf("\n");
-1===b&&(b=this.blame.Message.length);var e=h.createElement(d,"a");e.href=this.blame.CommitLink;e.appendChild(d.createTextNode(this.blame.Message.substring(0,b)));a.appendChild(e);a.appendChild(h.createElement(d,"br"));a.appendChild(d.createTextNode(h.formatMessage(n.committerOnTime,this.blame.AuthorName,this.blame.Time)));return a},A=this.getModel();this.showAnnotations(b,[e.ANNOTATION_BLAME,e.ANNOTATION_CURRENT_BLAME],function(d){var b=A.getLineStart(d.Start-1),m=A.getLineEnd(d.End-1,!0),b=k.AnnotationType.createAnnotation(e.ANNOTATION_BLAME,
b,m,p),m=a.slice(0);m.push(d.Shade);b.style=f.mixin({},b.style);b.style.style=f.mixin({},b.style.style);b.style.style.backgroundColor="rgba("+m.join()+")";b.groupId=d.Name;b.groupType=e.ANNOTATION_CURRENT_BLAME;b.createGroupAnnotation=u;b.html='\x3cimg class\x3d"annotationHTML blame" src\x3d"'+d.AuthorImage+'"/\x3e';b.blame=d;return b})},showSelection:function(b,a,d,e,f){"number"===typeof b?("number"!==typeof a&&(a=b),this.moveSelection(b,a)):"number"===typeof d&&(b=this.getModel().getLineStart(d-
1),"number"===typeof e&&(b+=e),"number"!==typeof f&&(f=0),this.moveSelection(b,b+f))},_setModelText:function(b){this._textView&&(this._textView.setText(b),this._textView.getModel().setLineDelimiter("auto"),this._highlightCurrentLine(this._textView.getSelection()))},setInput:function(b,a,d,e,f){g.prototype.setInput.call(this,b,a,d,e);this._textView&&(!e&&!f)&&this._textView.focus()},onGotoLine:function(b,a,d,e){if(this._textView){var f=this.getModel();b=Math.max(0,Math.min(b,f.getLineCount()-1));var l=
f.getLineStart(b),g=0;void 0===d&&(d=0);"string"===typeof a?(b=f.getLine(b).indexOf(a),-1!==b&&(g=b,d=g+a.length)):(g=a,a=f.getLineEnd(b)-l,g=Math.min(g,a),d=Math.min(d,a));this.moveSelection(l+g,l+d,e)}}});return{BaseEditor:g,Editor:p}});
define("orion/editor/find","i18n!orion/editor/nls/messages orion/keyBinding orion/editor/keyModes orion/editor/annotations orion/regex orion/objects orion/util".split(" "),function(n,s,r,k,f,h,g){function p(a){var d=a.getTextView();r.KeyMode.call(this,d);this.editor=a;this._active=!1;this._success=!0;this._ignoreSelection=!1;this._prefix="";d.setAction("incrementalFindCancel",function(){this.setActive(!1);return!0}.bind(this));d.setAction("incrementalFindBackspace",function(){return this._backspace()}.bind(this));
...
define("orion/editor/findUI",["i18n!orion/editor/nls/messages","orion/editor/find","orion/objects","orion/editor/util","orion/util"],function(n,s,r,k,f){function h(f,h,e){s.Find.call(this,f,h,e)}h.prototype=new s.Find;r.mixin(h.prototype,{getFindString:function(){var f=this._findInput;return!f?s.Find.prototype.getFindString.call(this):f.value},getReplaceString:function(){var f=this._replaceInput;return!f?s.Find.prototype.getReplaceString(this):f.value},hide:function(){var f=this.isVisible();s.Find.prototype.hide.call(this);
...
{name:n.undo});a.setAction("redo",function(a){if(this.undoStack){var d=1;a&&a.count&&(d=a.count);for(;0<d;)this.undoStack.redo(),--d;return!0}return!1}.bind(this),{name:n.redo});a.setKeyBinding(new s.KeyBinding("f",!0),"find");a.setAction("find",function(){if(this._find){var a=this.editor.getSelection();this._find.show({findString:this.editor.getText(a.start,a.end)});return!0}return!1}.bind(this),{name:n.find});a.setKeyBinding(new s.KeyBinding("k",!0),"findNext");a.setAction("findNext",function(a){return this._find?
(this._find.find(!0,a),!0):!1}.bind(this),{name:n.findNext});a.setKeyBinding(new s.KeyBinding("k",!0,!0),"findPrevious");a.setAction("findPrevious",function(a){return this._find?(this._find.find(!1,a),!0):!1}.bind(this),{name:n.findPrevious});a.setKeyBinding(new s.KeyBinding("j",!0),"incrementalFind");a.setAction("incrementalFind",function(){this._incrementalFind&&this._incrementalFind.find(!0);return!0}.bind(this),{name:n.incrementalFind});a.setKeyBinding(new s.KeyBinding("j",!0,!0),"incrementalFindReverse");
a.setAction("incrementalFindReverse",function(){this._incrementalFind&&this._incrementalFind.find(!1);return!0}.bind(this),{name:n.incrementalFindReverse});a.setAction("tab",function(){return this.indentLines()}.bind(this));a.setAction("shiftTab",function(){return this.unindentLines()}.bind(this),{name:n.unindentLines});a.setKeyBinding(new s.KeyBinding(38,!1,!1,!0),"moveLinesUp");a.setAction("moveLinesUp",function(){return this.moveLinesUp()}.bind(this),{name:n.moveLinesUp});a.setKeyBinding(new s.KeyBinding(40,
!1,!1,!0),"moveLinesDown");a.setAction("moveLinesDown",function(){return this.moveLinesDown()}.bind(this),{name:n.moveLinesDown});a.setKeyBinding(new s.KeyBinding(38,!0,!1,!0),"copyLinesUp");a.setAction("copyLinesUp",function(){return this.copyLinesUp()}.bind(this),{name:n.copyLinesUp});a.setKeyBinding(new s.KeyBinding(40,!0,!1,!0),"copyLinesDown");a.setAction("copyLinesDown",function(){return this.copyLinesDown()}.bind(this),{name:n.copyLinesDown});a.setKeyBinding(new s.KeyBinding("d",!0,!1,!1),
"deleteLines");a.setAction("deleteLines",function(a){return this.deleteLines(a)}.bind(this),{name:n.deleteLines});a.setKeyBinding(new s.KeyBinding("l",!g.isMac,!1,!1,g.isMac),"gotoLine");a.setAction("gotoLine",function(){return this.gotoLine()}.bind(this),{name:n.gotoLine});a.setKeyBinding(new s.KeyBinding(190,!0),"nextAnnotation");a.setAction("nextAnnotation",function(){return this.nextAnnotation(!0)}.bind(this),{name:n.nextAnnotation});a.setKeyBinding(new s.KeyBinding(188,!0),"previousAnnotation");
a.setAction("previousAnnotation",function(){return this.nextAnnotation(!1)}.bind(this),{name:n.prevAnnotation});a.setKeyBinding(new s.KeyBinding("e",!0,!1,!0,!1),"expand");a.setAction("expand",function(){return this.expandAnnotation(!0)}.bind(this),{name:n.expand});a.setKeyBinding(new s.KeyBinding("c",!0,!1,!0,!1),"collapse");a.setAction("collapse",function(){return this.expandAnnotation(!1)}.bind(this),{name:n.collapse});a.setKeyBinding(new s.KeyBinding("e",!0,!0,!0,!1),"expandAll");a.setAction("expandAll",
function(){return this.expandAnnotations(!0)}.bind(this),{name:n.expandAll});a.setKeyBinding(new s.KeyBinding("c",!0,!0,!0,!1),"collapseAll");a.setAction("collapseAll",function(){return this.expandAnnotations(!1)}.bind(this),{name:n.collapseAll});a.setKeyBinding(new s.KeyBinding("q",!g.isMac,!1,!1,g.isMac),"lastEdit");a.setAction("lastEdit",function(){return this.gotoLastEdit()}.bind(this),{name:n.lastEdit})},copyLinesDown:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;
...
n=l.getAnnotations(a?p:0,a?h.getCharCount():p),r=null;n.hasNext();){var s=n.next();if(a){if(s.start<=p)continue}else if(s.start>=p)continue;if(!e(s)&&(r=s,a))break}if(r){for(var D=[r],n=l.getAnnotations(r.start,r.start);n.hasNext();)s=n.next(),s!==r&&!e(s)&&D.push(s);var q=f.getTextView(),z=h.getLineAtOffset(r.start),C=k.Tooltip.getTooltip(q);if(!C)return f.moveSelection(r.start),!0;f.moveSelection(r.start,r.start,function(){C.setTarget({getTooltipInfo:function(){var a=q.convert({x:q.getLocationAtOffset(r.start).x,
...
p;e.prototype={init:function(){var a=this.editor.getTextView();a.setAction("lineStart",function(){return this.lineStart()}.bind(this));a.setAction("enter",function(){return this.autoIndent()}.bind(this));a.setKeyBinding(new s.KeyBinding("t",!0,!1,!0),"trimTrailingWhitespaces");a.setAction("trimTrailingWhitespaces",function(){return this.trimTrailingWhitespaces()}.bind(this),{name:n.trimTrailingWhitespaces});a.setKeyBinding(new s.KeyBinding(191,!0),"toggleLineComment");a.setAction("toggleLineComment",
function(){return this.toggleLineComment()}.bind(this),{name:n.toggleLineComment});a.setKeyBinding(new s.KeyBinding(191,!0,!g.isMac,!1,g.isMac),"addBlockComment");a.setAction("addBlockComment",function(){return this.addBlockComment()}.bind(this),{name:n.addBlockComment});a.setKeyBinding(new s.KeyBinding(220,!0,!g.isMac,!1,g.isMac),"removeBlockComment");a.setAction("removeBlockComment",function(){return this.removeBlockComment()}.bind(this),{name:n.removeBlockComment});a.setKeyBinding(new s.KeyBinding("[",
...
function(){return this.autoPairQuotations("'")}.bind(this));a.setKeyBinding(new s.KeyBinding('"',!1,!1,!1,!1,"keypress"),"autoPairDblQuotation");a.setAction("autoPairDblQuotation",function(){return this.autoPairQuotations('"')}.bind(this));a.setAction("deletePrevious",function(){return this.deletePrevious()}.bind(this))},autoIndent:function(){var a=this.editor,b=a.getTextView();if(b.getOptions("readonly"))return!1;var e=a.getSelection();if(e.start===e.end){for(var f=a.getModel(),g=f.getLineAtOffset(e.start),
h=f.getLine(g,!1),k=f.getLineStart(g),p=0,n=e.start-k,r;p<n&&(32===(r=h.charCodeAt(p))||9===r);)p++;var k=h.substring(0,p),b=b.getOptions("tabSize","expandTab"),s=b.expandTab?Array(b.tabSize+1).join(" "):"\t",b=f.getLineDelimiter(),q=/^[\s]*\/\*[\*]*[\s]*$/,z=/^[\s]*\*/,C=/\*\/[\s]*$/,E=h.substring(0,n),B=h.substring(n),I;if(this.smartIndentation&&123===h.charCodeAt(I=E.trimRight().length-1))return f=n-I-1,B=B.length-B.trimLeft().length,h=125===h.charCodeAt(n+B)?b+k+s+b+k:b+k+s,a.setText(h,e.start-
f,e.end+B),a.setCaretOffset(e.start+b.length+k.length+s.length-f),!0;if(this.autoCompleteComments&&!C.test(E)&&(q.test(E)||z.test(E))){if(p=q.exec(E)){h=b+k+" * ";h=C.test(B)?h+B.substring(0,B.length-2).trim():h+B.trim();if(f.getLineCount()===g+1||!z.test(f.getLine(g+1)))h+=b+k+" */";a.setText(h,e.start,e.end+B.length);a.setCaretOffset(e.start+b.length+k.length+3);return!0}if(p=z.exec(E))for(g-=1;0<=g;g--){p=f.getLine(g,!1);if(q.test(p))return C.test(B)||47===h.charCodeAt(n)?(h=b+k+"*"+B,k=e.start+
b.length+k.length+1):(h=b+k+"* "+B,k=e.start+b.length+k.length+2),a.setText(h,e.start,e.end+B.length),a.setCaretOffset(k),!0;if(!z.test(p))break}}else{if(C.test(E)&&32===k.charCodeAt(k.length-1))return h=b+k.substring(0,k.length-1),a.setText(h,e.start,e.end),a.setCaretOffset(e.start+h.length),!0;if(0<p){for(p=n;p<h.length&&(32===(r=h.charCodeAt(p++))||9===r);)e.end++;a.setText(f.getLineDelimiter()+k,e.start,e.end);return!0}}}return!1},addBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;
...
g=a.getLineAtOffset(e),h,k,p,n,r,s;for(h=f;0<=h&&!(k=a.getLine(h),p=h===f?b-a.getLineStart(f):k.length,n=k.lastIndexOf("/*",p),k=k.lastIndexOf("*/",p),k>n);h--)if(-1!==n){r=a.getLineStart(h)+n;break}for(h=g;h<a.getLineCount()&&!(k=a.getLine(h),p=h===g?e-a.getLineStart(g):0,n=k.indexOf("/*",p),k=k.indexOf("*/",p),-1!==n&&n<k);h++)if(-1!==k){s=a.getLineStart(h)+k;break}return{commentStart:r,commentEnd:s}},lineStart:function(){for(var a=this.editor,b=a.getModel(),e=a.getCaretOffset(),f=b.getLineAtOffset(e),
...
g.end-1:g.end),p=!0,n=[],r,s=h;s<=k;s++){var q=f.getLine(s,!0);r=q.indexOf(e);n.push(r);if(!p||-1===r)p=!1;else if(0!==r){for(p=0;p<r;p++){var z=q.charCodeAt(p);if(!(32===z||9===z))break}p=p===r}}s=e.length;q=f.getLineStart(h);b.setRedraw(!1);this.startUndo();if(p){for(p=n.length-1;0<=p;p--)r=n[p]+f.getLineStart(h+p),a.setText("",r,r+s);f=f.getLineStart(k);e=q===g.start?g.start:g.start-s;g=g.end-s*(k-h+1)+(g.end===f+1?s:0)}else{for(p=n.length-1;0<=p;p--)r=f.getLineStart(h+p),a.setText(e,r,r);e=q===
g.start?g.start:g.start+s;g=g.end+s*(k-h+1)}this.endUndo();b.setRedraw(!0);a.setSelection(e,g);return!0},trimTrailingWhitespaces:function(){var a=this.editor,b=a.getModel(),e=a.getSelection();a.getTextView().setRedraw(!1);a.getUndoStack().startCompoundChange();for(var f=/(\s+$)/,g=b.getLineCount(),h=0;h<g;h++){var k=b.getLine(h),p=f.exec(k);if(p){var n=b.getLineStart(h),k=p[0].length,p=n+p.index;b.setText("",p,p+k);e.start>p&&(e.start=Math.max(p,e.start-k));e.start!==e.end&&e.end>p&&(e.end=Math.max(p,
...
define("orion/editor/templates",[],function(){function n(n,k,f,h){this.prefix=n;this.description=k;this.template=f;this.name=h;this._parse()}function s(n,k){this._keywords=n||[];this._templates=[];this.addTemplates(k||[])}n.prototype={getProposal:function(n,k,f){n=k-n.length;k={};var h,g=void 0!==f.delimiter?f.delimiter:"\n";f.indentation&&(g+=f.indentation);var p=void 0!==f.tab?f.tab:"\t",e=0,b=this.variables,a=this.segments;f=[];for(var d=0;d<a.length;d++){var m=a[d],t=b[m];if(void 0!==t)switch(m){case "${tab}":m=
p;break;case "${delimiter}":m=g;break;case "${cursor}":m="";h=e;break;default:var l=k[m];l||(l=k[m]={data:t.data,positions:[]});m=t.substitution;l.data&&l.data.values&&(m=l.data.values[0]);l.positions.push({offset:n+e,length:m.length})}f.push(m);e+=m.length}var g=[],u;for(u in k)k.hasOwnProperty(u)&&g.push(k[u]);f=f.join("");void 0===h&&(h=f.length);return{proposal:f,name:this.name,description:this.description,groups:g,escapePosition:n+h,style:"noemphasis"}},match:function(n){return 0===this.prefix.indexOf(n)},
_parse:function(){var n=this.template,k=[],f={},h,g=0,n=n.replace(/\n/g,"${delimiter}"),n=n.replace(/\t/g,"${tab}");n.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(p,e,b){var a=p.substring(2,p.length-1);e=p;var d=a,m=null,t=d.indexOf(":");-1!==t&&(d=d.substring(0,t),e="${"+d+"}",m=JSON.parse(a.substring(t+1).replace("\\}","}").trim()));(a=f[e])||(a=f[e]={});a.substitution=d;m&&(a.data=m);(h=n.substring(g,b))&&k.push(h);k.push(e);g=b+p.length;return d});(h=n.substring(g,n.length))&&k.push(h);this.segments=
...
d,n.oldOffset+q);this.ignoreVerify=!1;a.text=null;this._updateAnnotations(g)}}}.bind(this)}}var p={};g.prototype=new r.KeyMode;h.mixin(g.prototype,{createKeyBindings:function(){var e=s.KeyBinding,b=[];b.push({actionID:"linkedModeEnter",keyBinding:new e(13)});b.push({actionID:"linkedModeCancel",keyBinding:new e(27)});b.push({actionID:"linkedModeNextGroup",keyBinding:new e(9)});b.push({actionID:"linkedModePreviousGroup",keyBinding:new e(9,!1,!0)});return b},enterLinkedMode:function(e){if(!this.linkedModeModel){var b=
...
define("orion/editor/factories","orion/editor/actions orion/editor/undoStack orion/editor/rulers orion/editor/annotations orion/editor/textDND orion/editor/linkedMode".split(" "),function(n,s,r,k,f,h){function g(){}function p(){}function e(){}function b(){}function a(){}function d(){}var m={};g.prototype={createKeyBindings:function(a,b,d,e){e=new n.TextActions(a,b,e);var f=new h.LinkedMode(a,b,d);a=new n.SourceCodeActions(a,b,d,f);return{textActions:e,linkedMode:f,sourceCodeActions:a}}};m.KeyBindingsFactory=
g;p.prototype={createUndoStack:function(a){a=a.getTextView();return new s.UndoStack(a,200)}};m.UndoFactory=p;e.prototype={createLineNumberRuler:function(a){return new r.LineNumberRuler(a,"left",{styleClass:"ruler lines"},{styleClass:"rulerLines odd"},{styleClass:"rulerLines even"})}};m.LineNumberRulerFactory=e;b.prototype={createFoldingRuler:function(a){return new r.FoldingRuler(a,"left",{styleClass:"ruler folding"})}};m.FoldingRulerFactory=b;a.prototype={createAnnotationModel:function(a){return new k.AnnotationModel(a)},
...
define("orion/editor/editorFeatures",["orion/editor/factories","orion/editor/actions","orion/editor/linkedMode","orion/objects"],function(n,s,r,k){return k.mixin({},n,s,r)});
(function(n,s){"function"===typeof define&&define.amd?define("orion/Deferred",s):"object"===typeof exports?module.exports=s():(n.orion=n.orion||{},n.orion.Deferred=s())})(this,function(){function n(){for(var g;g=f.shift();)g();h=!1}function s(k){f.push(k);h||(h=!0,g())}function r(f){return function(e){f(e)}}function k(){function f(){for(var a;a=h.shift();){var b=a.deferred,e="fulfilled"===g?"resolve":"reject";a=a[e];if("function"===typeof a)try{var l=a(d),k=l&&("object"===typeof l||"function"===typeof l)&&
l.then;if("function"===typeof k)if(l===b.promise)b.reject(new TypeError);else{var p=l.cancel;"function"===typeof p?b._parentCancel=p.bind(l):delete b._parentCancel;k.call(l,r(b.resolve),r(b.reject),r(b.progress))}else b.resolve(l)}catch(n){b.reject(n)}else b[e](d)}}function e(a){delete l._parentCancel;g="rejected";d=a;h.length&&s(f)}function b(a){function n(a){return function(b){(!g||"assumed"===g)&&a(b)}}delete l._parentCancel;try{var r=a&&("object"===typeof a||"function"===typeof a)&&a.then;if("function"===
typeof r)if(a===l)e(new TypeError);else{g="assumed";var w=a&&a.cancel;if("function"!==typeof w){var y=new k;a=y.promise;try{r(y.resolve,y.reject,y.progress)}catch(x){y.reject(x)}w=a.cancel;r=a.then}d=a;r.call(a,n(b),n(e));l._parentCancel=w.bind(a)}else g="fulfilled",d=a,h.length&&s(f)}catch(D){n(e)(D)}}function a(){var a=l._parentCancel;a?(delete l._parentCancel,a()):g||(a=Error("Cancel"),a.name="Cancel",e(a))}var d,g,h=[],l=this;this.resolve=function(a){g||b(a);return l};this.reject=function(a){g||
...
define("orion/editor/contentAssist","i18n!orion/editor/nls/messages orion/keyBinding orion/editor/keyModes orion/editor/eventTarget orion/Deferred orion/objects orion/editor/util orion/util orion/webui/littlelib".split(" "),function(n,s,r,k,f,h,g,p,e){function b(a){this.textView=a;this.state=m.INACTIVE;this.clearProviders();var b=this;this._textViewListeners={onModelChanging:function(a){(this._latestModelChangingEvent=a)&&this._updateFilterText(a)}.bind(this),onSelection:function(a){this.isDeactivatingChange(this._latestModelChangingEvent,
a)?this.setState(m.INACTIVE):this.isActive()&&(this.state===m.ACTIVE&&this.setState(m.FILTERING),this.filterProposals());this._latestModelChangingEvent=null}.bind(this),onScroll:function(a){this.setState(m.INACTIVE)}.bind(this)};a.setKeyBinding(p.isMac?new s.KeyBinding(" ",!1,!1,!1,!0):new s.KeyBinding(" ",!0),"contentAssist");a.setKeyBinding(p.isMac?new s.KeyBinding(" ",!1,!1,!0,!0):new s.KeyBinding(" ",!0,!1,!0),"contentAssist");a.setAction("contentAssist",function(){a.getOptions("readonly")||b.activate();
...
t=this,b=b.map(function(a){a=a.provider;var b;try{var d,e;if(d=a.computeContentAssist){var l=t.editorContextProvider,k=l.getEditorContext();p=h.mixin(p,l.getOptions());e=d.apply(a,[k,p])}else if(d=a.getProposals||a.computeProposals)e=d.apply(a,[g.getText(),m,p]);b=t.progress?t.progress.progress(e,"Generating content assist proposal"):e}catch(n){return(new f).reject(n)}return f.when(b)});return f.all(b,this.handleError)},filterProposals:function(a){if(this._computedProposals&&(this._latestModelChangingEvent||
...
return{id:n[n.length-1].id,grammars:n,keywords:s}});
define("webtools/cssContentAssist",["orion/editor/templates","orion/editor/stylers/text_css/syntax"],function(n,s){function r(a){return JSON.stringify(a).replace("}","\\}")}function k(){}for(var f={type:"link",values:"visible hidden scroll auto no-display no-content".split(" ")},h={type:"link",values:"solid dashed dotted double groove ridge inset outset".split(" ")},g={type:"link",values:[]},p=0;10>p;p++)g.values.push(p.toString());for(var e={type:"link",values:"black white red green blue magenta yellow cyan grey darkred darkgreen darkblue darkmagenta darkcyan darkyellow darkgray lightgray".split(" ")},
...
0;p<a.length;p++)f=a[p],b.push({prefix:f,description:f+" - "+f+" style",template:f+": ${width:"+r(g)+"}px ${style:"+r(h)+"} ${color:"+r(e)+"};"});k.prototype=new n.TemplateContentAssist(s.keywords,b);k.prototype.getPrefix=function(a,b,e){for(e=b;e&&/[A-Za-z\-\@]/.test(a.charAt(e-1));)e--;return e?a.substring(e,b):""};return{CssContentAssistProvider:k}});
define("webtools/htmlContentAssist",["orion/editor/templates"],function(n){function s(){}var r=new n.Template("","Simple HTML document",'\x3c!DOCTYPE html\x3e\n\x3chtml lang\x3d"en"\x3e\n\t\x3chead\x3e\n\t\t\x3cmeta charset\x3dutf-8\x3e\n\t\t\x3ctitle\x3e${title}\x3c/title\x3e\n\t\x3c/head\x3e\n\t\x3cbody\x3e\n\t\t\x3ch1\x3e${header}\x3c/h1\x3e\n\t\t\x3cp\x3e\n\t\t\t${cursor}\n\t\t\x3c/p\x3e\n\t\x3c/body\x3e\n\x3c/html\x3e'),k=[{prefix:"\x3cimg",name:"\x3cimg\x3e",description:" - HTML image element",
...
h="\x3c"+f+"\x3e\n\t${cursor}\n\x3c/"+f+"\x3e",k.push({prefix:"\x3c"+f,description:g,template:h});e="area base br col hr input link meta param keygen source".split(" ");for(p=0;p<e.length;p++)f=e[p],h=g="\x3c"+f+"/\x3e",k.push({prefix:"\x3c"+f,description:g,template:h});s.prototype=new n.TemplateContentAssist([],k);s.prototype.getPrefix=function(b,a,d){d="";for(var e=a;e&&/[A-Za-z0-9<!-]/.test(b.charAt(e-1));)if(e--,"\x3c"===b.charAt(e)){d=b.substring(e,a);break}return d};s.prototype.computeProposals=
function(b,a,d){return 0===b.length?[r.getProposal("",a,d)]:n.TemplateContentAssist.prototype.computeProposals.call(this,b,a,d).sort(function(a,b){var d=a.prefix||a.proposal,e=b.prefix||b.proposal;if(d){if(!e)return 1}else return-1;return d.toLowerCase().localeCompare(e.toLowerCase())})};return{HTMLContentAssistProvider:s}});
define("orion/editor/AsyncStyler",["i18n!orion/editor/nls/messages","orion/editor/annotations"],function(n,s){function r(g){return-1!==g.getProperty("objectClass").indexOf(f)&&"highlighter"===g.getProperty("type")}function k(f,h,e){this.initialize(f,h,e);this.lineStyles=[]}var f="orion.edit.highlighter",h=f+" service must be an event emitter";s.AnnotationType.registerType("orion.annotation.highlightError",{title:n.syntaxError,html:"\x3cdiv class\x3d'annotationHTML error'\x3e\x3c/div\x3e",rangeStyle:{styleClass:"annotationRange error"}});
...
e.push(k),"cm-error"===p&&f.push(k))}return[e,f]},getLineStyle:function(b){return this.lines[b]},getLineStyles:function(){return this.lines}};s.EventTarget.addMixin(p.prototype);r.AnnotationType.registerType("orion.annotation.highlightError",{title:n.syntaxError,html:"\x3cdiv class\x3d'annotationHTML error'\x3e\x3c/div\x3e",rangeStyle:{styleClass:"annotationRange error"}});e.prototype={init:function(b,a,d){this.textView=b;this.annotationModel=d;this.modeApplier=new p(b.getModel(),a);var e=this;this.listener=
...
"",k.push(g?n.escape(b):b)):k.push(b)}return RegExp(k.join(""))},groupify:function(f,h){for(var g=f.source,k=g.length,e=[],b=0,a=[],d=1,m=1,n=[],l={},u={},r=0;r<k;r++){var s=e[e.length-1],w=g.charAt(r);switch(w){case "(":4===s&&(e.pop(),n.push(")"),a[a.length-1].end=r);var y=r+2<k?g.charAt(r+1)+""+g.charAt(r+2):null;if("?:"===y||"?\x3d"===y||"?!"===y){var x;"?:"===y?x=1:(x=3,b++);e.push(x);a.push({start:r,end:-1,type:x});n.push(w);n.push(y);r+=y.length}else e.push(2),a.push({start:r,end:-1,type:2,
oldNum:d,num:m}),n.push(w),0===b&&(u[m]=null),l[d]=m,d++,m++;break;case ")":s=e.pop();3===s&&b--;a[a.length-1].end=r;n.push(w);break;case "*":case "+":case "?":case "}":var D=w,q=g.charAt(r-1),y=r-1;if("}"===w){for(x=r-1;"{"!==g.charAt(x)&&0<=x;x--);q=g.charAt(x-1);y=x-1;D=g.substring(x,r+1)}x=a[a.length-1];if(")"===q&&(2===x.type||4===x.type)){n.splice(x.start,0,"(");n.push(D);n.push(")");w={start:x.start,end:n.length-1,type:4,num:x.num};for(q=0;q<a.length;q++)if(s=a[q],(2===s.type||4===s.type)&&
s.start>=x.start&&s.end<=y)s.start+=1,s.end+=1,s.num+=1,2===s.type&&(l[s.oldNum]=s.num);a.push(w);m++;break}default:"|"!==w&&(2!==s&&4!==s)&&0===b&&(e.push(4),a.push({start:r,end:-1,type:4,num:m}),n.push("("),u[m]=null,m++),n.push(w),"\\"===w&&(w=g.charAt(r+1),n.push(w),r+=1)}}for(;e.length;)e.pop(),n.push(")");g=RegExp(n.join(""));k={};h=h||l;for(var z in h)h.hasOwnProperty(z)&&(k[z]="\\"+h[z]);g=this.getSubstitutedRegex(g,k,!1);return[g,l,u]},complexCaptures:function(f){if(!f)return!1;for(var h in f)if(f.hasOwnProperty(h)&&
...
h},parse:function(f,h,g,k,e,b){var a=this.textView.getModel(),d=a.getLineStart(a.getLineCount()-1),m=a.getCharCount(),n=this.getInitialExpected(f,g),l=-1;h&&(f.repaired=!0,f.endNeedsUpdate=!0,l=(l=f.children[f.children.length-1])?a.getLineEnd(a.getLineAtOffset(l.end+(e-b))):-1,k=a.getLineEnd(a.getLineAtOffset(k+b)),l=Math.max(l,k));l=-1===l?m:l;k=n;for(var u=f,r=!1,s=g,w=-1;u&&(!h||s<l);){var y=this.getNextMatch(a,u,s);y||(s=s>=d?m:a.getLineStart(a.getLineAtOffset(s)+1));var x=y&&y.match,D=y&&y.rule,
q=y&&y.isEnd;if(y&&y.isSub)s=this.afterMatch(x),D instanceof this.BeginEndRule&&(r=!0,h&&D===k.rule&&u===k.parent?(u=k,u.setStart(x),u.repaired=!0,u.endNeedsUpdate=!0,k=this.getNextExpected(k,"begin")):(h&&(this.prune(u,k),h=!1),x=new this.BeginEndNode(u,D,x),u.addChild(x),u=x));else if(q||s===m)u instanceof this.BeginEndNode&&(x?(r=!0,w=Math.max(w,u.end),u.setEnd(x),s=this.afterMatch(x),h&&u===k&&u.parent===k.parent?(u.repaired=!0,delete u.endNeedsUpdate,k=this.getNextExpected(k,"end")):h&&(this.prune(u,
k),h=!1)):(u.setEnd(m),delete u.endNeedsUpdate)),u=u.parent;h&&(s>=l&&!r)&&(this.prune(f,n),h=!1)}this.removeUnrepairedChildren(f,h,g);this.cleanup(h,f,g,l,m,e,b);return h?Math.max(w,s):s},removeUnrepairedChildren:function(f,h,g){if(h){h=f.children;for(var k=-1,e=0;e<h.length;e++){var b=h[e];if(!b.repaired&&this.isDamaged(b,g,Number.MAX_VALUE)){k=e;break}}-1!==k&&(f.children.length=k)}},cleanup:function(f,h,g,k,e,b,a){if(f){f=b-a;e=this.getIntersecting(k-f+1,e);h=this.getIntersecting(g,k);for(g=0;g<
...
-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var n=0;0<k.length;){var p=k[0];k.splice(0,1);if(g<p.result.index)break;if(!(p.result.index<n)){var n=d+p.result.index,r=p.result.index,s=null,D=p.pattern.regexEnd;if(D){var r=r+p.result[0].length,q=p.pattern,z=this._substituteCaptureValues(D,p.result);z!==D&&(q={pattern:q.pattern,regexBegin:q.regexBegin,regexEnd:z},D=z);for(z=r;!s;){z=this._findMatch(D,b,z);z||(this._eolRegex.lastIndex=0,z=this._eolRegex.exec(b),
q={pattern:q.pattern,regexBegin:q.regexBegin,regexEnd:this._eolRegex});var C=this.createBlock({start:n,end:d+z.index+z[0].length,contentStart:d+r,contentEnd:d+z.index},a.styler,e,a,q),E=C.getBlocks();if(!E.length||E[E.length-1].end<=z.index+d)s=C;z=z.index+z[0].length}}else s=this.createBlock({start:n,end:n+p.result[0].length,contentStart:n,contentEnd:n+p.result[0].length},a.styler,e,a,p.pattern);h.push(s);if(h.length===l||g<=s.end)break;n=s.end-d}this._updateMatch(p,b,k,n,g)}return h},computeStyle:function(e,
...
g[0];g.splice(0,1);if(!(h.result.index<l)){var k=h.result.index,n,p=[];if(h.pattern.regex){l=h.result;n=k+l[0].length;n={start:b+k,end:b+n,style:h.pattern.pattern.name};if(!f){h.pattern.pattern.captures&&this._getCaptureStyles(l,h.pattern.pattern.captures,b+k,p);p.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(k=0;k<p.length-1;k++)if(p[k+1].start<p[k].end){var r={start:p[k+1].end,end:p[k].end,style:p[k].style};p[k].end=p[k+1].start;p.splice(k+2,0,r)}}this._mergeStyles(n,p,
d)}else l=h.pattern.regexEnd,l=this._substituteCaptureValues(l,h.result),l=this._findMatch(l,e,h.result.index+h.result[0].length),l||(this._eolRegex.lastIndex=0,l=this._eolRegex.exec(e)),n=l.index+l[0].length,d.push({start:b+k,end:b+n,style:h.pattern.pattern.name});l=l.index+l[0].length}this._updateMatch(h,e,g,l)}a.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},setStyler:function(){},verifyBlock:function(e,b,a,d){var f=null,g=[];a.parent.blockPatterns.forEach(function(a){var d=
...
f.prototype={adjustBounds:function(e,b){e<this.start&&(this.start+=b);e<this.contentStart&&(this.contentStart+=b);e<=this.end&&(this.end+=b);e<=this.contentEnd&&(this.contentEnd+=b);this._subBlocks.forEach(function(a){e<=a.end&&a.adjustBounds(e,b)})},getBlocks:function(){return this._subBlocks},isRenderingWhitespace:function(){return this.styler._isRenderingWhitespace()}};h.prototype={getStyles:function(e){return this._styler.getStyles(e)}};g.prototype={computeBlocks:function(e,b,a,d,f,g,h){return this._stylerAdapter.computeBlocks(e,
b,a,d,f,g,h)},destroy:function(){if(this._view){var e=this._view.getModel();e.getBaseModel&&(e=e.getBaseModel());e.removeEventListener("Changed",this._listener.onChanged);this._view.removeEventListener("MouseDown",this._listener.onMouseDown);this._view.removeEventListener("Selection",this._listener.onSelection);this._view.removeEventListener("Destroy",this._listener.onDestroy);this._view.removeEventListener("LineStyle",this._listener.onLineStyle);this._view=null}},getBlockAtIndex:function(e){return this._findBlock(this._rootBlock,
e)},getRootBlock:function(){return this._rootBlock},getStyleAccessor:function(){return this._accessor},getStyles:function(e){var b=[],a=this._view.getModel();a.getBaseModel&&(a=a.getBaseModel());var d=this._findBlock(this._rootBlock,e),f=a.getLineAtOffset(e),g=a.getLine(f),h=[];this._stylerAdapter.parse(g,a.getLineStart(f),d,h);for((f=h[p(h,e,!0)])&&(f.start<=e&&e<f.end)&&b.push(f);d;)(f=this._stylerAdapter.computeStyle(d,a,e))&&b.splice(0,0,f),d=d.parent;return b},setDetectHyperlinks:function(){},
...
b){this._whitespacesVisible!==e&&(this._whitespacesVisible=e,b&&this._view.redraw())},_computeFolding:function(e,b,a){if(b.getBaseModel){var d=b.getBaseModel();e.forEach(function(e){var f=this._createFoldingAnnotation(b,d,e.start,e.end);f&&a.push(f);this._computeFolding(e.getBlocks(),b,a)}.bind(this))}},_computeTasks:function(e,b,a,d,f){d=d||e.start;f=f||e.end;if(e.start<=f&&d<=e.end&&this._annotationModel){var g=n.AnnotationType.ANNOTATION_TASK;if(e.name&&0===e.name.indexOf("comment")){var h=[];
this._stylerAdapter.parse(b.getText(e.contentStart,e.end),e.contentStart,e,h,!0);for(var k=0;k<h.length;k++)"meta.annotation.task.todo"===h[k].style&&(d<=h[k].start&&h[k].end<=f)&&a.push(n.AnnotationType.createAnnotation(g,h[k].start,h[k].end,b.getText(h[k].start,h[k].end)))}e.getBlocks().forEach(function(e){this._computeTasks(e,b,a,d,f)}.bind(this))}},_createFoldingAnnotation:function(e,b,a,d){var f=b.getLineAtOffset(a),g=b.getLineAtOffset(d);return f===g||f+1===g&&b.getLineStart(g)===b.getLineEnd(g)?
null:new (n.AnnotationType.getType(n.AnnotationType.ANNOTATION_FOLDING))(a,d,e)},_findBlock:function(e,b){var a=e.getBlocks();if(!a.length)return e;var d=p(a,b,!0);return d<a.length&&a[d].start<=b&&b<a[d].end?this._findBlock(a[d],b):e},_findBrackets:function(e,b,a,d,f){for(var g=[],h=[],k=d,n=b.getBlocks(),r=p(n,d,!0);r<n.length&&!(n[r].start>=f);r++){var s=n[r].start,y=n[r].end;k<s&&(this._stylerAdapter.parse(a.substring(k-d,s-d),k,b,h),h.forEach(function(a){0===a.style.indexOf(e.beginName)?g.push(a.start+
1):0===a.style.indexOf(e.endName)&&g.push(-(a.start+1))}),h=[]);k=y}k<f&&(this._stylerAdapter.parse(a.substring(k-d,f-d),k,b,h),h.forEach(function(a){a.style&&(0===a.style.indexOf(e.beginName)?g.push(a.start+1):0===a.style.indexOf(e.endName)&&g.push(-(a.start+1)))}));return g},_findMatchingBracket:function(e,b,a){var d=e.getLineAtOffset(a),f=e.getLineEnd(d),g=e.getText(a,f),g=this._stylerAdapter.getBracketMatch(b,g);if(!g)return-1;for(var h=e.getLine(d),k=e.getLineStart(d),f=this._findBrackets(g,
b,h,k,f),n=0;n<f.length;n++)if(h=0<=f[n]?1:-1,f[n]*h-1===a){a=1;if(g.atStart){for(n++;n<f.length;n++)if(h=0<=f[n]?1:-1,a+=h,0===a)return f[n]*h-1;d+=1;for(n=e.getLineCount();d<n;){h=e.getLine(d);k=e.getLineStart(d);f=e.getLineEnd(d);f=this._findBrackets(g,b,h,k,f);for(k=0;k<f.length;k++)if(h=0<=f[k]?1:-1,a+=h,0===a)return f[k]*h-1;d++}}else{for(n--;0<=n;n--)if(h=0<=f[n]?1:-1,a+=h,0===a)return f[n]*h-1;for(d-=1;0<=d;){h=e.getLine(d);k=e.getLineStart(d);f=e.getLineEnd(d);f=this._findBrackets(g,b,h,
k,f);for(n=f.length-1;0<=n;n--)if(h=0<=f[n]?1:-1,a+=h,0===a)return f[n]*h-1;d--}}break}return-1},_getLineStyle:function(e){if(this._highlightCaretLine){var b=this._view.getModel(),a=this._view.getSelection();if(a.start===a.end&&b.getLineAtOffset(a.start)===e)return this._caretLineStyle}return null},_getStyles:function(e,b,a,d){b.getBaseModel&&(d=b.mapOffset(d));for(var f=d+a.length,g=[],h=d,k=e.getBlocks(),n=p(k,d,!0);n<k.length&&!(k[n].start>=f);n++){var r=k[n].start,s=k[n].end;h<r&&this._stylerAdapter.parse(a.substring(h-
d,r-d),h,e,g);var y=Math.max(h,r);y===r&&(r=this._stylerAdapter.getBlockStartStyle(k[n],a.substring(y-d),y,g))&&(y+=r.length);var r=Math.min(f,s),x=[];r===s&&(h=a.substring(r-h-(k[n].end-k[n].contentEnd)),(h=this._stylerAdapter.getBlockEndStyle(k[n],h,r,x))&&(r-=h.length));var h=this._getStyles(k[n],b,a.substring(y-d,r-d),y),D=this._stylerAdapter.getBlockContentStyleName(k[n]);if(D){var q=y;h.forEach(function(a){a.start-q&&g.push({start:q,end:a.start,style:D});a.mergeable&&(a.style+=","+D);g.push(a);
q=a.end});r-q&&g.push({start:q,end:r,style:D})}else g=g.concat(h);g=g.concat(x);h=s}h<f&&this._stylerAdapter.parse(a.substring(h-d,f-d),h,e,g);if(b.getBaseModel)for(e=0;e<g.length;e++)a=g[e].end-g[e].start,g[e].start=b.mapOffset(g[e].start,!0),g[e].end=g[e].start+a;return g},_isRenderingWhitespace:function(){return this._whitespacesVisible&&(this._tabsVisible||this._spacesVisible)},_onDestroy:function(){this.destroy()},_onLineStyle:function(e){e.textView===this._view&&(e.style=this._getLineStyle(e.lineIndex));
e.ranges=this._getStyles(this._rootBlock,e.textView.getModel(),e.lineText,e.lineStart);e.ranges.forEach(function(b){b.style&&(b.style={styleClass:b.style.replace(/\./g," ")})});this._isRenderingWhitespace()&&(this._spacesVisible&&this._spliceStyles(this._spacePattern,e.ranges,e.lineText,e.lineStart),this._tabsVisible&&this._spliceStyles(this._tabPattern,e.ranges,e.lineText,e.lineStart))},_onModelChanged:function(e){var b=e.start,a=e.removedCharCount;e=e.addedCharCount-a;var d=this._view.getModel(),
f=d.getBaseModel?d.getBaseModel():d,a=b+a,g=f.getCharCount(),h=f.getLineStart(f.getLineAtOffset(b)),k=this._findBlock(this._rootBlock,b),r,s,w,y,x,D,q;do{w=k.parent;if(!r&&w&&(x=f.getText(k.start,Math.min(g,k.end+e+1)),!this._stylerAdapter.verifyBlock(f,x,k,e))){k=w;continue}s=k.getBlocks();var z=s.length,C=p(s,h,!0),E=p(s,a,!1,C-1,z);r=!1;if(C&&s.length&&s[C-1].end===b){x=f.getText(s[C-1].start,Math.min(g,b+1));var B=this.computeBlocks(f,x,k,s[C-1].start,null,null,null);B.length&&B[0].end!==s[C-
1].end&&(C--,r=!0)}C<z&&s[C].start<=h&&(h<s[C].end||r)?(q=s[C].start,q>b&&(q+=e)):C===z&&0<z&&k.end-e===s[z-1].end?(q=s[z-1].start,q>b&&(q+=e)):q=h;D=E<z?s[E].end:k.contentEnd;b<=D&&(D+=e);D=Math.min(D,g-1);x=f.getText(q,D+1);B=this.computeBlocks(f,x,k,q,null,null,null);if(E<z){if(B.length&&B[B.length-1].end===D&&B[B.length-1].typeId===s[E].typeId)break;if(B.length&&this._stylerAdapter.blockSpansBeyondEnd(B[B.length-1])){E++;for(var I=B[B.length-1].getBlocks(),I=(I.length?I[I.length-1]:B[B.length-
1]).typeId;E<z;){if(s[E].typeId===I){var L=s[E].end+e,L=Math.min(L,g-1);x=f.getText(q,L+1);x=this.computeBlocks(f,x,k,q,null,null,null);if(x.length&&x[x.length-1].end===L){D=L;B=x;break}}E++}if(E<z)break}}else if(!B.length||B[B.length-1].end<=k.contentEnd+e)break;if(!w){D=g;E=z;x=f.getText(q,D);B=this.computeBlocks(f,x,k,q,null,null,null);break}k=w;y=!0}while(1);this._rootBlock.adjustBounds(b,e);E=Math.min(E+1,z);y||(y=E-C!==B.length);if(!y)for(z=0;z<B.length;z++)if(r=s[C+z],g=B[z],r.start!==g.start||
r.end!==g.end||r.typeId!==g.typeId){y=!0;break}!s.length&&!B.length?this.dispatchEvent({type:"BlocksChanged",old:[k],"new":[k]}):this.dispatchEvent({type:"BlocksChanged",old:s.slice(C,E),"new":B});C=[C,E-C].concat(B);Array.prototype.splice.apply(s,C);y&&(s=q,y=D,d!==f&&(s=d.mapOffset(s,!0),y=d.mapOffset(y,!0)),this._view.redrawRange(s,y));if(this._annotationModel){s=[];var O=[],H=[];y=this._annotationModel.getAnnotations(q,D);C=this._foldingEnabled&&f!==d;for(E=k.parent||k;y.hasNext();)B=y.next(),
C&&B.type===n.AnnotationType.ANNOTATION_FOLDING?(H.push(B),r=this._findBlock(E,B.start),!r||!(B.start===r.start&&B.end===r.end)?(s.push(B),B.expand()):(r=B.start,z=B.end,r>b&&(r-=e),z>b&&(z-=e),r<=b&&(b<z&&r<=a&&a<z)&&(r=f.getLineAtOffset(B.start),z=f.getLineAtOffset(B.end),r!==z?B.expanded||B.expand():s.push(B)))):B.type===n.AnnotationType.ANNOTATION_TASK&&k.start<=B.start&&B.end<=k.end&&s.push(B);C&&E.getBlocks().forEach(function(a){this._updateFolding(a,f,d,H,O,q,D)}.bind(this));this._detectTasks&&
this._computeTasks(k,f,O,q,D);this._annotationModel.replaceAnnotations(s,O)}},_onMouseDown:function(e){if(2===e.clickCount){var b=this._view.getModel(),a=this._view.getOffsetAtLocation(e.x,e.y);if(0<a){var d=a-1,f=b;b.getBaseModel&&(d=b.mapOffset(d),f=b.getBaseModel());var g=this._findBlock(this._rootBlock,d),d=this._findMatchingBracket(f,g,d);-1!==d&&(e.preventDefault(),e=d,b.getBaseModel&&(e=b.mapOffset(e,!0)),a>e&&(a--,e++),this._view.setSelection(e,a))}}},_onSelection:function(e){var b=e.oldValue,
a=e.newValue;e=this._view.getModel();var d;if(this._highlightCaretLine){var f=e.getLineAtOffset(b.start);d=e.getLineAtOffset(a.start);var g=a.start===a.end,b=b.start===b.end;f===d&&b&&g||(b&&this._view.redrawLines(f,f+1),(f!==d||!b)&&g&&this._view.redrawLines(d,d+1))}if(this._annotationModel){var b=this._bracketAnnotations,h,k;if(a.start===a.end&&0<(k=this._view.getCaretOffset()))k-=1,e.getBaseModel&&(k=e.mapOffset(k),e=e.getBaseModel()),a=this._findBlock(this._rootBlock,k),e=this._findMatchingBracket(e,
a,k),-1!==e&&(h=[n.AnnotationType.createAnnotation(n.AnnotationType.ANNOTATION_MATCHING_BRACKET,e,e+1),n.AnnotationType.createAnnotation(n.AnnotationType.ANNOTATION_CURRENT_BRACKET,k,k+1)]);this._bracketAnnotations=h;this._annotationModel.replaceAnnotations(b,h)}},_spliceStyles:function(e,b,a,d){for(var f=e.regex,g=f.lastIndex=0,h=f.exec(a);h;){for(h=d+h.index;g<b.length&&!(h<b[g].end);)g++;var k={start:h,end:h+1,style:e.style};if(g<b.length&&b[g].start<=h){var n={start:h+1,end:b[g].end,style:b[g].style};
b[g].end=h;b.splice(g+1,0,n);b.splice(g+1,0,k);g+=2}else b.splice(g,0,k),g++;h=f.exec(a)}},_updateFolding:function(e,b,a,d,f,g,h){g=g||e.start;h=h||e.end;if(e.start<=h&&g<=e.end){var k=p(d,e.start,!0);k<d.length&&d[k].start===e.start&&d[k].end===e.end||(k=this._createFoldingAnnotation(a,b,e.start,e.end))&&f.push(k);e.getBlocks().forEach(function(e){this._updateFolding(e,b,a,d,f,g,h)}.bind(this))}},_caretLineStyle:{styleClass:"meta annotation currentLine"},_spacePattern:{regex:/[ ]/g,style:{styleClass:"punctuation separator space",
unmergeable:!0}},_tabPattern:{regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}}};s.EventTarget.addMixin(g.prototype);return{TextStyler:g,Block:f,createPatternBasedAdapter:function(e,b){return new r(e,b)}}});
define("orion/editor/stylers/application_javascript/syntax",["orion/editor/stylers/lib/syntax"],function(n){var s="break case class catch continue const debugger default delete do else enum export extends false finally for function if implements import in instanceof interface let new null package private protected public return static super switch this throw true try typeof undefined var void while with yield".split(" ");n=n.grammars;n.push({id:"orion.js",contentTypes:["application/javascript"],patterns:[{begin:"'(?:\\\\.|[^\\\\'])*\\\\$",
...
{include:"orion.lib#bracket_open"},{include:"orion.lib#bracket_close"},{include:"orion.lib#parenthesis_open"},{include:"orion.lib#parenthesis_close"},{include:"orion.lib#number_decimal"},{include:"orion.lib#number_hex"},{match:"\\b(?:"+s.join("|")+")\\b",name:"keyword.control.js"}]});return{id:n[n.length-1].id,grammars:n,keywords:s}});
...
define("orion/editor/stylers/text_html/syntax",["orion/editor/stylers/lib/syntax","orion/editor/stylers/application_javascript/syntax","orion/editor/stylers/text_css/syntax","orion/editor/stylers/application_xml/syntax"],function(n,s,r,k){n=n.grammars.concat(s.grammars).concat(r.grammars).concat(k.grammars);n.push({id:"orion.html",contentTypes:["text/html"],patterns:[{begin:"(?i)(\x3cstyle)([^\x3e]*)(\x3e)",end:"(?i)(\x3c/style\x3e)",captures:{1:{name:"entity.name.tag.html"},3:{name:"entity.name.tag.html"}},
